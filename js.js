/*1527851996,,JIT Construction: v3963173,en_US*/
...
try {
            ...
            with (this) {
                ...
                (function (a) {
                    ...
                    require = function (d, e) {
                        ...
                        e = b[d];
                        var f = e.deps, g = e.factory.length, h, i = [];
                        for (var j = 0; j < g; j++) {
                            switch (f[j]) {
                                case"module":
                                    h = e;
                ...
                __d("ES5ArrayPrototype", [], (function (a, b, c, d, e, f) {
                    ...
                    g.map = function (a, b) {
                        ...
                        var c = void 0, d = this.length, e = new Array(d);
                    ...
                    g.filter = function (a, b) {
                        if (typeof a != "function") throw new TypeError();
                        var c = void 0, d = void 0, e = this.length, f = [];
                    ...
                    a = {
                        from: function (a) {
                            ...
                            var b = arguments[1], c = arguments[2], d = this, e = Object(a),
                                ...
                                g = typeof b === "function", h = typeof e[f] === "function", i = 0, j = void 0, k;
                            void 0;
                            if (h) {
                    ...
                    var g = {
                        find: function (a, b) {
                            ...
                            var b = Object(this), c = b.length >>> 0, d = arguments[1], e = d >> 0,
                                f = e < 0 ? Math.max(c + e, 0) : Math.min(e, c), g = arguments[2],
                                h = g === undefined ? c : g >> 0, i = h < 0 ? Math.max(c + h, 0) : Math.min(h, c);
                            while (f < i) b[f] = a, f++;
                            return b
                        }
                    };
                ...
                __d("ES6Number", [], (function (a, b, c, d, e, f) {
                    ...
                    d = {
                        ...
                        }, EPSILON: a, MAX_SAFE_INTEGER: b, MIN_SAFE_INTEGER: c
                    };
                    e.exports = d
                }), null);
                    ...
                    a = {
                        assign: function (a) {
                            ...
                            for (var e = 0; e < c.length; e++) {
                                ...
                                if (f == null) continue;
                                f = Object(f);
                                for (var i in f) h.call(f, i) && (a[i] = f[i]);
                                g(f, function (b) {
                                    return a[b] = f[b]
                                })
                            }
                ...
                __d("ES7ArrayPrototype", ["ES5ArrayPrototype", "ES5Array"], (function (a, b, c, d, e, f, g, h) {
                    __p && __p();
                    var i = g.indexOf, j = h.isArray;
                    ...
                    a = {
                        includes: function (a) {
                            "use strict";
                            __p && __p();
                            if (a !== undefined && j(this) && !(typeof a === "number" && isNaN(a))) return i.apply(this, arguments) !== -1;
                            var b = Object(this), c = b.length ? k(b.length) : 0;
                            if (c === 0) return !1;
                            var d = arguments.length > 1 ? l(arguments[1]) : 0, e = d < 0 ? Math.max(c + d, 0) : d,
                ...
                __d("json3-3.3.2", [], (function (a, b, c, d, e, f) {
                    ...
                    function j() {
                        ...
                        (function () {
                            __p && __p();
                            var b = typeof i === "function" && i.amd, c = {"function": !0, object: !0},
                                d = c[typeof g] && g && !g.nodeType && g, e = c[typeof window] && window || this,
                            ...
                            function k(b, a) {
                                ...
                                b || (b = e.Object());
                                a || (a = e.Object());
                                var d = b.Number || e.Number, g = b.String || e.String, h = b.Object || e.Object,
                                    i = b.Date || e.Date, j = b.SyntaxError || e.SyntaxError,
                                    l = b.TypeError || e.TypeError, m = b.Math || e.Math;
                                b = b.JSON || e.JSON;
                                ...
                                function s(b) {
                                    ...
                                    if (s[b] !== q) return s[b];
                                    var c;
                                    if (b == "bug-string-char-index") c = "a"[0] != "a"; else if (b == "json") c = s("json-stringify") && s("json-parse"); else {
                                        var e, f = '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}';
                                        if (b == "json-stringify") {
                                            var h = a.stringify, j = typeof h == "function" && r;
                                            if (j) {
                                                (e = function () {
                                                    return 1
                                                }).toJSON = e;
                                                try {
                                                    j = h(0) === "0" && h(new d()) === "0" && h(new g()) == '""' && h(n) === q && h(q) === q && h() === q && h(e) === "1" && h([e]) == "[1]" && h([q]) == "[null]" && h(null) == "null" && h([q, n, null]) == "[null,null,null]" && h({a: [e, !0, !1, null, "\0\b\n\f\r\t"]}) == f && h(null, e) === "1" && h([1, 2], null, 1) == "[\n 1,\n 2\n]" && h(new i(-864e13)) == '"-271821-04-20T00:00:00.000Z"' && h(new i(864e13)) == '"+275760-09-13T00:00:00.000Z"' && h(new i(-621987552e5)) == '"-000001-01-01T00:00:00.000Z"' && h(new i(-1)) == '"1969-12-31T23:59:59.999Z"'
                                                } catch (a) {
                                                    j = !1
                                                }
                                            }
                                ...
                                if (!s("json")) {
                                    var t = "[object Function]", u = "[object Date]", v = "[object Number]",
                                        w = "[object String]", x = "[object Array]", y = "[object Boolean]",
                                    ...
                                    if (!s("json-stringify")) {
                                        var D = {
                                            ...
                                            13: "\\r",
                                            9: "\\t"
                                        }, E = "000000", F = function (a, b) {
                                            return (E + (b || 0)).slice(-a)
                                        }, G = "\\u00", H = function (a) {
                                            __p && __p();
                                            var b = '"', c = 0, d = a.length, e = !z || d > 10,
                                                f = e && (z ? a.split("") : a);
                                            for (; c < d; c++) {
                                            ...
                                            if (typeof h == "object" && h) {
                                                i = n.call(h);
                                                if (i == u && !o.call(h, "toJSON")) if (h > -1 / 0 && h < 1 / 0) {
                                                    if (C) {
                                                        m = A(h / 864e5);
                                                ...
                                                } else h = null; else typeof h.toJSON == "function" && (i != v && i != w && i != x || o.call(h, "toJSON")) && (h = h.toJSON(a))
                                            }
                                            c && (h = c.call(b, a, h));
                                            if (h === null) return "null";
                                            i = n.call(h);
                                            if (i == y) return "" + h; else if (i == v) return h > -1 / 0 && h < 1 / 0 ? "" + h : "null"; else if (i == w) return H("" + h);
                                            if (typeof h == "object") {
                                        ...
                                        a.stringify = function (a, b, d) {
                                            __p && __p();
                                            var e, f, g, h;
                                            if (c[typeof b] && b) if ((h = n.call(b)) == t) f = b; else if (h == x) {
                                                g = {};
                                                for (var i = 0, j = b.length, k; i < j; k = b[i++], (h = n.call(k), h == w || h == v) && (g[k] = 1)) ;
                                            }
                                            if (d) if ((h = n.call(d)) == v) {
                                    ...
                                    if (!s("json-parse")) {
                                        var J = g.fromCharCode, K = {
                                            ...
                                            var d = a[b], e;
                                            if (typeof d == "object" && d) if (n.call(d) == x) for (e = d.length; e--;) Q(d, e, c); else p(d, function (a) {
                                                Q(d, a, c)
                                            });
                                            return c.call(a, b, d)
                                        };
                            ...
                            if (d && !b) k(e, d); else {
                                var l = e.JSON, m = e.JSON3, n = !1, o = k(e, e.JSON3 = {
                                    noConflict: function () {
                ...
                __d("ES", ["json3", "ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "ES6Array", "ES6Object", "ES6ArrayPrototype", "ES6DatePrototype", "ES6Number", "ES7StringPrototype", "ES7Object", "ES7ArrayPrototype"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    __p && __p();
                    var v = {}.toString, w = {"JSON.stringify": g.stringify, "JSON.parse": g.parse};
                    c = {
                        "Array.prototype": h,
                    ...
                    d = {Object: o, "Array.prototype": p, "Date.prototype": q, Number: r, Array: n};
                    f = {Object: t, "String.prototype": s, "Array.prototype": u};
                        ...
                        for (var b in a) {
                            ...
                            if (d.length === 2) {
                                ...
                                if (!e || !f || !window[e] || !window[e][f]) {
                                    var g = e ? window[e] : "-", h = e && window[e] && f ? window[e][f] : "-";
                    ...
                    function b(a, b, c) {
                        var d = c ? v.call(a).slice(8, -1) + ".prototype" : a, e = w[d + "." + b] || a[b];
                        if (typeof e === "function") {
                            for (var f = arguments.length, g = Array(f > 3 ? f - 3 : 0), h = 3; h < f; h++) g[h - 3] = arguments[h];
                            return e.apply(a, g)
                        } else if (e) return e;
                ...
                (function (a, b) {
                    ...
                    function k(a, b) {
                        if (typeof a === "string") return g[b || d](a); else if (ES("Array", "isArray", !1, a)) return f[b || d](a); else if (a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]) return a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"](); else return j[b || e](a)
                    }
                ...
                (function (a, b) {
                    ...
                    var g = a.FB_enumerate, h = function () {
                        ...
                        var i = "key", j = "value", k = "key+value", l = "$map_", m = void 0, n = "IE_HASH_";
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/oVjM2wVZ10b.js?version=42",
                ...
                __d("Log", ["sprintf"], (function (a, b, c, d, e, f, g) {
                    ...
                    function a(a, b) {
                        var c = Array.prototype.slice.call(arguments, 2), d = g.apply(null, c), e = window.console;
                ...
                __d("UrlMap", ["UrlMapConfig"], (function (a, b, c, d, e, f, g) {
                    ...
                    a = {
                        resolve: function (a, b) {
                            var c = typeof b == "undefined" ? location.protocol.replace(":", "") : b ? "https" : "http";
                            if (a in g) return c + "://" + g[a];
                            if (typeof b == "undefined" && a + "_" + c in g) return c + "://" + g[a + "_" + c];
                            if (b !== !0 && a + "_http" in g) return "http://" + g[a + "_http"];
                            if (b !== !1 && a + "_https" in g) return "https://" + g[a + "_https"]
                        }
                    };
                    e.exports = a
                }), null);
                __d("QueryString", [], (function (a, b, c, d, e, f) {
                    ...
                    function b(a) {
                        __p && __p();
                        var b = arguments.length <= 1 || arguments[1] === undefined ? !1 : arguments[1], c = {};
                        if (a === "") return c;
                        var d = a.split("&");
                        for (var e = 0; e < d.length; e++) {
                            var f = d[e].split("=", 2), g = decodeURIComponent(f[0]);
                            if (b && Object.prototype.hasOwnProperty.call(c, g)) throw new URIError("Duplicate key: " + g);
                            c[g] = f.length === 2 ? decodeURIComponent(f[1]) : null
                        }
                        return c
                    }
                ...
                __d("Assert", ["AssertionError", "sprintf"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    function j(a, b, c) {
                        __p && __p();
                        var d;
                        if (b === undefined) d = "undefined"; else if (b === null) d = "null"; else {
                    ...
                    var l = {
                        isInstanceOf: a, isTrue: i, isTruthy: function (a, b) {
                            return i(!!a, b)
                        }, type: j, define: function (a, b) {
                ...
                __d("sdk.Runtime", ["sdk.Model", "JSSDKRuntimeConfig"], (function (a, b, c, d, e, f, g, h) {
                    __p && __p();
                    var i = {UNKNOWN: 0, PAGETAB: 1, CANVAS: 2, PLATFORM: 4}, j = new g({
                        AccessToken: "",
                        AutoLogAppEvents: !1,
                        ClientID: "",
                        CookieUserID: "",
                    ...
                    ES("Object", "assign", !1, j, {
                        ENVIRONMENTS: i, isEnvironment: function (a) {
                ...
                __d("sdk.Cookie", ["QueryString", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    function j(a, b, c) {
                        a = a + h.getClientID();
                        var d = i && i !== ".";
                        d && (document.cookie = a + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT;", document.cookie = a + "=; expires=Wed, 04 Feb 2004 08:00:00 GMT;domain=" + location.hostname + ";");
                        var e = new Date(c).toGMTString();
                        document.cookie = a + "=" + b + (b && c === 0 ? "" : "; expires=" + e) + "; path=/" + (d ? "; domain=" + i : "")
                    }

                    function k(a) {
                        a = a + h.getClientID();
                        a = new RegExp("\\b" + a + "=([^;]*)\\b");
                        return a.test(document.cookie) ? RegExp.$1 : null
                    }

                    a = {
                        setDomain: function (a) {
                            i = a;
                            a = g.encode({base_domain: i && i !== "." ? i : ""});
                            var b = new Date();
                ...
                __d("Miny", [], (function (a, b, c, d, e, f) {
                    __p && __p();
                    var g = "Miny1", h = "wxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_".split("");
                    a = {
                        encode: function (a) {
                            __p && __p();
                ...
                __d("sdk.UA", [], (function (a, b, c, d, e, f) {
                    ...
                    var g = {
                        ...
                        i = {ie: "", firefox: "", chrome: "", webkit: "", osx: "", edge: "", operaMini: "", ucWeb: ""};
                ...
                __d("insertIframe", ["GlobalCallback", "getBlankIframeSrc", "guid"], (function (a, b, c, d, e, f, g, h, i) {
                    ...
                    function a(a) {
                        ...
                        var b = !1, c = !1, d = function () {
                            b && !c && (c = !0, a.onload && a.onload(a.root.firstChild))
                        }, e = g.create(d);
                        if (document.attachEvent) {
                            var f = '<iframe id="' + a.id + '" name="' + a.name + '"' + (a.title ? ' title="' + a.title + '"' : "") + (a.className ? ' class="' + a.className + '"' : "") + ' style="border:none;' + (a.width ? "width:" + a.width + "px;" : "") + (a.height ? "height:" + a.height + "px;" : "") + '" src="' + h() + '" frameborder="0" scrolling="no" allowtransparency="true" onload="' + e + '()"></iframe>';
                            a.root.innerHTML = '<iframe src="' + h() + '" frameborder="0" scrolling="no" style="height:1px"></iframe>';
                            b = !0;
                            setTimeout(function () {
                                a.root.innerHTML = f, a.root.firstChild.src = a.url, a.onInsert && a.onInsert(a.root.firstChild)
                            }, 0)
                        } else {
                            ...
                            a.width !== undefined && (a.width == "100%" ? e.style.width = a.width : e.style.width = a.width + "px");
                ...
                __d("sdk.domReady", ["sdk.Runtime"], (function (a, b, c, d, e, f, g) {
                    __p && __p();
                    var h;
                    ...
                    if (!b) {
                        h = [];
                        document.addEventListener ? (document.addEventListener("DOMContentLoaded", i, !1), window.addEventListener("load", i, !1)) : document.attachEvent && (document.attachEvent("onreadystatechange", i), window.attachEvent("onload", i));
                        if (document.documentElement.doScroll && window == window.top) {
                            c = function a() {
                                try {
                                    g.getRtl() ? document.documentElement.doScroll("right") : document.documentElement.doScroll("left")
                                } catch (b) {
                                    setTimeout(a, 0);
                                    return
                                }
                ...
                __d("sdk.Content", ["Log", "sdk.UA", "sdk.domReady"], (function (a, b, c, d, e, f, g, h, i) {
                    ...
                    var j, k = {
                        append: function (a, b) {
                            b || (!j ? (j = b = document.getElementById("fb-root"), b || (g.warn('The "fb-root" div has not been created, auto-creating'), j = b = document.createElement("div"), b.id = "fb-root", h.ie() || !document.body ? i(function () {
                                document.body.appendChild(b)
                            }) : document.body.appendChild(b)), b.className += " fb_reset") : b = j);
                            if (typeof a == "string") {
                            ...
                            c.method = b ? "GET" : "POST";
                            k.appendHidden(c);
                            for (var d in a.params) if (Object.prototype.hasOwnProperty.call(a.params, d)) {
                                b = a.params[d];
                ...
                __d("sdk.Impressions", ["sdk.Content", "Miny", "QueryString", "sdk.Runtime", "UrlMap", "getBlankIframeSrc", "guid", "insertIframe"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    ...
                    function o(a) {
                        ...
                        a.kid_directed_site = j.getKidDirectedSite();
                        b = k.resolve("www", !0) + "/impression.php/" + m() + "/";
                        var c = i.appendToUrl(b, a);
                        if (c.length > 2e3 && (a.payload && typeof a.payload === "string")) {
                            var d = h.encode(a.payload);
                            d && d.length < a.payload.length && (a.payload = d, c = i.appendToUrl(b, a))
                        }
                        if (c.length <= 2e3) {
                            d = new Image();
                            d.src = c
                            ...
                            d = m();
                            var e = g.appendHidden("");
                            n({
                                url: l(), root: e, name: d, className: "fb_hidden fb_invisible", onload: function () {
                                    e.parentNode.removeChild(e)
                                }
                            });
                            g.submitToTarget({url: b, target: d, params: a})
                        }
                    }

                    a = {
                        log: function (a, b) {
                            b.source || (b.source = "jssdk"), o({lid: a, payload: ES("JSON", "stringify", !1, b)})
                        }, impression: o
                    };
                    e.exports = a
                }), null);
                __d("sdk.Scribe", ["QueryString", "sdk.Runtime", "UrlMap"], (function (a, b, c, d, e, f, g, h, i) {
                    function a(a, b) {
                        typeof b.extra == "object" && (b.extra.revision = h.getRevision()), new Image().src = g.appendToUrl(i.resolve("www", !0) + "/common/scribe_endpoint.php", {
                            c: a,
                ...
                __d("createObjectFrom", [], (function (a, b, c, d, e, f) {
                    ...
                    function g(a, b) {
                        ...
                        var c = {};
                        if (ES("Array", "isArray", !1, b)) for (var d = a.length - 1; d >= 0; d--) c[a[d]] = b[d]; else for (var d = a.length - 1; d >= 0; d--) c[a[d]] = b;
                        return c
                    }
                ...
                __d("invariant", ["ex", "sprintf"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    function a(a, b) {
                        ...
                        if (!a) {
                            var c = void 0;
                            if (b === undefined) c = new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings."); else {
                                for (var d = arguments.length, e = Array(d > 2 ? d - 2 : 0), f = 2; f < d; f++) e[f - 2] = arguments[f];
                                c = new Error(i.apply(undefined, [b].concat(e)));
                ...
                __d("URIBase", ["URIRFC3986", "URISchemes", "ex", "invariant", "setHostSubdomain"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function n(a, b, c, d) {
                        ...
                        a.setPort(e.port || "");
                        a.setPath(e.path || "");
                        if (c) a.setQueryData(d.deserialize(e.query || "") || {}); else try {
                        ...
                        if (e.userinfo !== null) if (c) throw new Error(i("URI.parse: invalid URI (userinfo is not allowed in a URI): %s", a.toString())); else return !1;
                        if (!a.getDomain() && ES(a.getPath(), "indexOf", !0, "\\") !== -1) if (c) throw new Error(i("URI.parse: invalid URI (no domain but multiple back-slashes): %s", a.toString())); else return !1;
                        if (!a.getProtocol() && m.test(b)) if (c) throw new Error(i("URI.parse: invalid URI (unsafe protocol-relative URLs): %s", a.toString())); else return !1;
                        if (a.getDomain() && a.getPath() && !ES(a.getPath(), "startsWith", !0, "/")) if (c) throw new Error(i("URI.parse: invalid URI (domain and path where path lacks leading slash): %s", a.toString())); else return !1;
                        return !0
                    }
                ...
                __d("Queue", [], (function (a, b, c, d, e, f) {
                    ...
                    h.prototype._dispatch = function (a) {
                        ...
                        if (this._opts.interval) this._opts.processor.call(this, this._queue.shift()), this._timeout = setTimeout(ES(this._dispatch, "bind", !0, this), this._opts.interval); else while (this._queue.length) this._opts.processor.call(this, this._queue.shift())
                    };
                ...
                __d("DOMEventListener", ["emptyFunction", "invariant", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                    var j = !1;
                    try {
                    ...
                    window.addEventListener ? (k = function (a, b, c) {
                        ...
                        c.wrapper = i(c, "entry", "DOMEventListener.add " + b), a.attachEvent || h(0), a.attachEvent("on" + b, c.wrapper)
                    }, l = function (a, b, c) {
                ...
                __d("htmlSpecialChars", [], (function (a, b, c, d, e, f) {
                    ...
                    function a(a) {
                        ...
                        if (a === !1) return "0"; else if (a === !0) return "1";
                        return a.toString().replace(g, "&amp;").replace(j, "&quot;").replace(k, "&#039;").replace(h, "&lt;").replace(i, "&gt;")
                    }
                ...
                __d("Flash", ["DOMEventListener", "DOMWrapper", "QueryString", "UserAgent_DEPRECATED", "guid", "htmlSpecialChars"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    var m = {}, n, o = h.getWindow().document;
                    ...
                    function q() {
                        for (var a in m) Object.prototype.hasOwnProperty.call(m, a) && p(a)
                    }
                    ...
                    function s(a) {
                        n || (j.ie() >= 9 && g.add(window, "unload", q), n = !0), m[a] = a
                    }
                    ...
                    var t = {
                        embed: function (a, b, c, d) {
                            ...
                            var e = k();
                            a = l(a).replace(/&amp;/g, "&");
                            c = babelHelpers["extends"]({allowscriptaccess: "always", flashvars: d, movie: a}, c);
                            typeof c.flashvars == "object" && (c.flashvars = i.encode(c.flashvars));
                            d = [];
                            for (var f in c) Object.prototype.hasOwnProperty.call(c, f) && c[f] && d.push('<param name="' + l(f) + '" value="' + l(c[f]) + '">');
                            b = b.appendChild(o.createElement("span"));
                            a = "<object " + (j.ie() ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ' : 'type="application/x-shockwave-flash"') + 'data="' + a + '" ' + (c.height ? 'height="' + c.height + '" ' : "") + (c.width ? 'width="' + c.width + '" ' : "") + 'id="' + e + '">' + d.join("") + "</object>";
                            b.innerHTML = a;
                            c = b.firstChild;
                            s(e);
                            return c
                        }, remove: p, getVersion: function () {
                            var a = "Shockwave Flash", b = "application/x-shockwave-flash",
                                c = "ShockwaveFlash.ShockwaveFlash", d;
                            if (navigator.plugins && typeof navigator.plugins[a] == "object") {
                                a = navigator.plugins[a].description;
                                a && navigator.mimeTypes && navigator.mimeTypes[b] && navigator.mimeTypes[b].enabledPlugin && (d = a.match(/\d+/g))
                            }
                            if (!d) try {
                                d = new ActiveXObject(c).GetVariable("$version").match(/(\d+),(\d+),(\d+),(\d+)/), d = Array.prototype.slice.call(d, 1)
                            } catch (a) {
                            }
                            return d
                ...
                __d("XDM", ["DOMEventListener", "DOMWrapper", "emptyFunction", "Flash", "GlobalCallback", "guid", "Log", "UserAgent_DEPRECATED", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    function s(a) {
                        __p && __p();
                        var b = {}, c = a.length, d = q.transports;
                        while (c--) b[a[c]] = 1;
                        c = d.length;
                        while (c--) {
                            a = d[c];
                    ...
                    a = {
                        register: function (a, b) {
                            m.debug("Registering %s as XDM provider", a), q.transports.push(a), p[a] = b
                        }, create: function (a) {
                            __p && __p();
                            ...
                            a.channel || (m.warn("Missing channel name, selecting at random"), a.channel = l());
                            a.whenReady || (a.whenReady = i);
                            a.onMessage || (a.onMessage = i);
                            var b = a.transport || s(a.blacklist || []), c = p[b];
                            if (c && c.isAvailable()) {
                                m.debug("%s is available", b);
                                c.init(a);
                                return b
                            }
                        }
                    };
                    a.register("flash", function () {
                        __p && __p();
                        var a = !1, b, c = !1, d = 15e3, e;
                        return {
                            isAvailable: function () {
                                return j.checkMinVersion("8.0.24")
                            }, init: function (f) {
                                __p && __p();
                                m.debug("init flash: " + f.channel);
                                var g = {
                                    send: function (a, c, d, e) {
                                        m.debug("sending to: %s (%s)", c, e), b.postMessage(a, c, e)
                                    }
                                };
                                if (a) {
                                    f.whenReady(g);
                                ...
                                var h = f.root.appendChild(r.document.createElement("div")), i = k.create(function () {
                                    k.remove(i);
                                    clearTimeout(e);
                                    m.info("xdm.swf called the callback");
                                    var a = k.create(function (a, b) {
                                        a = decodeURIComponent(a), b = decodeURIComponent(b), m.debug("received message %s from %s", a, b), f.onMessage(a, b)
                                    }, "xdm.swf:onMessage");
                                    b.init(f.channel, a);
                                    f.whenReady(g)
                                }, "xdm.swf:load");
                                b = j.embed(f.flashUrl, h, null, {
                                ...
                                e = setTimeout(function () {
                                    m.warn("The Flash component did not load within %s ms - verify that the container is not set to hidden or invisible using CSS as this will cause some browsers to not load the components", d)
                                }, d);
                                a = !0
                            }
                        }
                    ...
                    a.register("postmessage", function () {
                        ...
                        return {
                            isAvailable: function () {
                                ...
                                __p && __p();
                                m.debug("init postMessage: " + b.channel);
                                var c = "_FB_" + b.channel, d = {
                                    send: function (a, b, c, d) {
                                        if (r === c) {
                                            m.error("Invalid windowref, equal to window (self)");
                                            throw new Error()
                                        }
                                        m.debug("sending to: %s (%s)", b, d);
                                        var e = function () {
                                            c.postMessage("_FB_" + d + a, b)
                                        };
                                        n.ie() == 8 || n.ieCompatibilityMode() ? setTimeout(e, 0) : e()
                                    }
                                };
                                if (a) {
                                    b.whenReady(d);
                                ...
                                g.add(r, "message", o(function (event) {
                                    __p && __p();
                                    var a = event.data, d = event.origin || "native";
                                    if (!/^(https?:\/\/|native$)/.test(d)) {
                                        m.debug("Received message from invalid origin type: %s", d);
                                        return
                                    }
                                    if (d !== "native" && !(t.test(location.hostname) || t.test(event.origin))) return;
                                    if (typeof a != "string") {
                                        m.warn("Received message of type %s from %s, expected a string", typeof a, d);
                                        return
                                    }
                                    m.debug("received message %s from %s", a, d);
                                    a.substring(0, c.length) == c && (a = a.substring(c.length));
                                    b.onMessage(a, d)
                                }, "entry", "onMessage"));
                                b.whenReady(d);
                                a = !0
                ...
                __d("sdk.Event", [], (function (a, b, c, d, e, f) {
                    __p && __p();
                    a = {
                        SUBSCRIBE: "event.subscribe", UNSUBSCRIBE: "event.unsubscribe", subscribers: function () {
                            ...
                            var b = Array.prototype.slice.call(arguments, 1), c = this.subscribers()[a];
                            c && ES(c, "forEach", !0, function (a) {
                                a && a.apply(this, b)
                            })
                        }
                    };
                ...
                __d("JSONRPC", ["Log"], (function (a, b, c, d, e, f, g) {
                    ...
                    a.prototype.stub = function (a) {
                        ...
                        this.remote[a] = ES(function () {
                            ...
                            b.params = d;
                            this.$4(ES("JSON", "stringify", !1, b), this.$3 || {method: a})
                        }, "bind", !0, this)
                    };
                    a.prototype.read = function (a, b) {
                        ...
                        if (!d) {
                            ...
                            f("error", {code: -32601, message: "Method not found", data: a.method});
                            return
                        }
                ...
                __d("sdk.RPC", ["Assert", "JSONRPC", "Queue"], (function (a, b, c, d, e, f, g, h, i) {
                    var j = new i(), k = new h(function (a) {
                        j.enqueue(a)
                    });
                    a = {
                        local: k.local, remote: k.remote, stub: ES(k.stub, "bind", !0, k), setInQueue: function (a) {
                            g.isInstanceOf(i, a), a.start(function (a) {
                                k.read(a)
                            })
                ...
                __d("hasNamePropertyBug", ["guid", "UserAgent_DEPRECATED"], (function (a, b, c, d, e, f, g, h) {
                    __p && __p();
                    var i = h.ie() ? undefined : !1;

                    function j() {
                        var a = document.createElement("form"), b = a.appendChild(document.createElement("input"));
                        b.name = g();
                ...
                __d("sdk.createIframe", ["DOMEventListener", "getBlankIframeSrc", "guid", "hasNamePropertyBug", "isNumberLike"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();

                    function a(a) {
                        __p && __p();
                        a = ES("Object", "assign", !1, {}, a);
                        var b, c = a.name || i(), d = a.root, e = a.style || {border: "none"}, f = a.url, l = a.onload,
                            m = a.onerror;
                        j() ? b = document.createElement('<iframe name="' + c + '"/>') : (b = document.createElement("iframe"), b.name = c);
                        delete a.style;
                        delete a.name;
                        delete a.url;
                        delete a.root;
                        ...
                        delete c.height;
                        delete c.width;
                        for (var n in c) Object.prototype.hasOwnProperty.call(c, n) && b.setAttribute(n, c[n]);
                        ES("Object", "assign", !1, b.style, e);
                        b.src = h();
                        d.appendChild(b);
                        if (l) var o = g.add(b, "load", function () {
                            o.remove(), l()
                        });
                        if (m) var p = g.add(b, "error", function () {
                            p.remove(), m()
                        });
                        b.src = f;
                        return b
                ...
                __d("sdk.FeatureFunctor", ["invariant"], (function (a, b, c, d, e, f, g) {
                    __p && __p();

                    function h(a, b, c) {
                        if (a.features && b in a.features) {
                            a = a.features[b];
                            if (typeof a === "object" && typeof a.rate === "number") if (a.rate && Math.random() * 100 <= a.rate) return a.value || !0; else return a.value ? null : !1; else return a
                        }
                        return c
                    }
                ...
                __d("sdk.feature", ["sdk.FeatureFunctor", "JSSDKConfig"], (function (a, b, c, d, e, f, g, h) {
                    e.exports = g.create(h)
                }), null);
                __d("sdk.XD", ["sdk.Content", "sdk.Event", "Log", "QueryString", "Queue", "sdk.RPC", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "UrlMap", "JSSDKXDConfig", "XDM", "isFacebookURI", "sdk.createIframe", "sdk.feature", "guid"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    __p && __p();
                    var w = new k(), x = new k(), y = new k(), z, A, B = v();
                    a = q.useCdn ? "cdn" : "www";
                    b = u("use_bundle", !1) ? q.XdBundleUrl : q.XdUrl;
                    var C = p.resolve(a, !1) + b, D = p.resolve(a, !0) + b;
                    c = function () {
                    ...
                    var E = v(), F = c(), G, H = !1, I = "Facebook Cross Domain Communication Frame", J = {},
                        K = new k();
                    l.setInQueue(K);

                    function L(a) {
                        i.info("Remote XD can talk to facebook.com (%s)", a), m.setEnvironment(a === "canvas" ? m.ENVIRONMENTS.CANVAS : m.ENVIRONMENTS.PAGETAB)
                    }
                    ...
                    function M(a, b) {
                        ...
                        var c = /^https?/.exec(b)[0];
                        switch (a.xd_action) {
                            case"proxy_ready":
                                var d, e;
                                c == "https" ? (d = y, e = A, m.setLoggedIntoFacebook(a.logged_in === "true")) : (d = x, e = z);
                                a.registered && (L(a.registered), w = d.merge(w));
                                i.info("Proxy ready, starting queue %s containing %s messages", c + "ProxyQueue", d.getLength());
                                d.start(function (a) {
                                    G.send(typeof a === "string" ? a : j.encode(a), b, e.contentWindow, E + "_" + c)
                                });
                                break;
                            case"plugin_ready":
                                i.info("Plugin %s ready, protocol: %s", a.name, c);
                                J[a.name] = {protocol: c};
                                if (k.exists(a.name)) {
                                    d = k.get(a.name);
                                    i.debug("Enqueuing %s messages for %s in %s", d.getLength(), a.name, c + "ProxyQueue");
                                    (c == "https" ? y : x).merge(d)
                                }
                                break
                        }
                    ...
                    function N(a, b) {
                        __p && __p();
                        if (b && b !== "native" && !s(new o(b))) return;
                        if (typeof a == "string") {
                            if (/^FB_RPC:/.test(a)) {
                            ...
                            if (a.substring(0, 1) == "{") try {
                                ...
                                i.warn("Failed to decode %s as JSON", a);
                                return
                            } else a = j.decode(a)
                        }
                        b || a.xd_sig == B && (b = a.xd_origin);
                        if (a.xd_action) {
                            M(a, b);
                            return
                        }
                        a.access_token && m.setSecure(/^https/.test(F));
                        if (a.cb) {
                            b = Q._callbacks[a.cb];
                            Q._forever[a.cb] || delete Q._callbacks[a.cb];
                            b && b(a)
                        }
                    }

                    function O(a, b) {
                        if (a == "facebook") b.relation = "parent.parent", w.enqueue(b); else {
                            b.relation = 'parent.frames["' + a + '"]';
                            var c = J[a];
                            c ? (i.debug("Enqueuing message for plugin %s in %s", a, c.protocol + "ProxyQueue"), (c.protocol == "https" ? y : x).enqueue(b)) : (i.debug("Buffering message for plugin %s", a), k.get(a).enqueue(b))
                        }
                    }

                    l.getOutQueue().start(function (a) {
                        O("facebook", "FB_RPC:" + a)
                    });
                    ...
                    function P(a) {
                        __p && __p();
                        if (H) return;
                        var b = g.appendHidden(document.createElement("div")), c = r.create({
                            blacklist: null,
                            root: b,
                            channel: E,
                            ...
                            whenReady: function (d) {
                                G = d;
                                d = {channel: E, origin: F, transport: c, xd_name: a};
                                d = "#" + j.encode(d);
                                m.getSecure() !== !0 && (z = t({
                                    url: C + d,
                    ...
                    var Q = {
                        ...
                        handler: function (a, b, c, d) {
                            ...
                            return (location.protocol == "https:" ? D : C) + a
                        },
                        ...
                        getXDArbiterURL: function (a) {
                            return a ? D : C
                        }
                    };
                    h.subscribe("init:post", function (a) {
                        P(a.xdProxyName);
                        var b = u("xd_timeout", !1);
                        b && setTimeout(function () {
                            var a = A && !!z == x.isStarted() && !!A == y.isStarted();
                            a || n.log("jssdk_error", {
                                appId: m.getClientID(),
                                error: "XD_INITIALIZATION",
                                extra: {message: "Failed to initialize in " + b + "ms"}
                            })
                        }, b)
                    });
                    e.exports = Q
                ...
                __d("sdk.Auth", ["sdk.Cookie", "sdk.createIframe", "DOMWrapper", "sdk.feature", "sdk.getContextType", "guid", "sdk.Impressions", "Log", "ObservableMixin", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "UrlMap", "sdk.URI", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    __p && __p();
                    var v = "fblo_", w = 365 * 24 * 60 * 60 * 1e3, x, y, z = new o();

                    function A(a, b) {
                        __p && __p();
                        var c = p.getUserID(), d = "";
                        if (a) if (a.userID) d = a.userID; else if (a.signedRequest) {
                            var e = r.parse(a.signedRequest);
                            e && e.user_id && (d = e.user_id)
                        }
                        e = p.getLoginStatus();
                        var f = e === "unknown" && a || p.getUseCookie() && p.getCookieUserID() !== d, g = c && !a;
                        c = a && c && c != d;
                        var h = a != x;
                        e = b != (e || "unknown");
                        p.setLoginStatus(b);
                        p.setAccessToken(a && a.accessToken || null);
                        p.setUserID(d);
                        x = a;
                        d = {authResponse: a, status: b};
                        (g || c) && z.inform("logout", d);
                        (f || c) && z.inform("login", d);
                        h && z.inform("authresponse.change", d);
                        e && z.inform("status.change", d);
                        return d
                    }
                    ...
                    function C(a, b, c) {
                        ...
                        return function (d) {
                            __p && __p();
                            if (d && d.access_token) {
                                var e = r.parse(d.signed_request);
                                b = {
                                ...
                                d.granted_scopes && (b.grantedScopes = d.granted_scopes);
                                d.reauthorize_required_in && (b.reauthorize_required_in = parseInt(d.reauthorize_required_in, 10));
                                if (p.getUseCookie()) {
                                    e = b.expiresIn === 0 ? 0 : ES("Date", "now", !1) + b.expiresIn * 1e3;
                                    var f = g.getDomain();
                                    !f && d.base_domain && g.setDomain("." + d.base_domain);
                                    g.setSignedRequestCookie(d.signed_request, e)
                                }
                                D();
                                f = "connected";
                                A(b, f)
                            } else (c === "logout" || c === "login_status") && (d.error && d.error === "not_authorized" ? f = "not_authorized" : d.error && d.error === "authorization_expired" ? f = "authorization_expired" : f = "unknown", A(null, f), p.getUseCookie() && g.clearSignedRequestCookie(), c === "logout" && (E(), q.log("jssdk_error", {
                                appId: p.getClientID(),
                                error: "PLATFORM_AUTH_LOGOUT",
                                extra: {args: {fblo: !0}}
                            })));
                            d && d.https == 1 && p.setSecure(!0);
                            a && a({authResponse: b, status: p.getLoginStatus()});
                            return b
                        }
                    }
                    ...
                    function E() {
                        g.setRaw(v, "y", ES("Date", "now", !1) + w)
                    }

                    function F(a) {
                        __p && __p();
                        var b, c = ES("Date", "now", !1);
                        y && (clearTimeout(y), y = null);
                        var d = g.getRaw(v) === "y";
                        j("getloginstatus_tracking", !0) && q.log("jssdk_error", {
                            appId: p.getClientID(),
                        ...
                        var e = C(a, x, "login_status");
                        d = new t(s.resolve("www", !0) + "/connect/ping").setQueryData({
                            client_id: p.getClientID(),
                            response_type: "token,signed_request,code",
                            domain: location.hostname,
                            origin: k(),
                            redirect_uri: u.handler(function (a) {
                                if (j("e2e_ping_tracking", !0)) {
                                    var d = {init: c, close: ES("Date", "now", !1), method: "ping"};
                                    n.debug("e2e: %s", ES("JSON", "stringify", !1, d));
                                    m.log(114, {payload: d})
                                }
                                b.parentNode.removeChild(b);
                                e(a) && (y = setTimeout(function () {
                                    F(function () {
                                    })
                                }, 12e5))
                            }, "parent"),
                            ...
                            version: p.getIsVersioned() ? p.getVersion() : null
                        });
                        b = h({root: i.getRoot(), name: l(), url: d.toString(), style: {display: "none"}})
                    }
                    ...
                    function a(a, b) {
                        ...
                        if (a) if (!b && G == "loaded") {
                            a({status: p.getLoginStatus(), authResponse: B()});
                            return
                        } else z.subscribe("FB.loginStatus", a);
                        if (!b && G == "loading") return;
                        G = "loading";
                        a = function (a) {
                            G = "loaded", z.inform("FB.loginStatus", a), z.clearSubscribers("FB.loginStatus")
                        };
                        F(a)
                    }

                    ES("Object", "assign", !1, z, {
                        removeLogoutState: D,
                        getLoginStatus: a,
                        fetchLoginStatus: F,
                        setAuthResponse: A,
                ...
                __d("sdk.DOM", ["Assert", "sdk.UA", "sdk.domReady"], (function (a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                    var j = {};
                    ...
                    function l(a, b) {
                        ...
                        try {
                            ...
                            throw new Error("Could not read property " + b + " : " + a.message)
                        }
                    }
                    ...
                    function c(a, b) {
                        g.isTruthy(a, "element not specified"), g.isString(b), m(a, b) || (a.className = l(a, "className") + " " + b)
                    }
                    ...
                    function f(a, b, c) {
                        ...
                        b = b || document.body;
                        c = c || "*";
                        if (b.querySelectorAll) return ES("Array", "from", !1, b.querySelectorAll(c + "." + a));
                        b = b.getElementsByTagName(c);
                        c = [];
                        for (var d = 0, e = b.length; d < e; d++) m(b[d], a) && (c[c.length] = b[d]);
                        return c
                    }
                    ...
                    function n(a, b) {
                        ...
                        a = a[b];
                        /backgroundPosition?/.test(b) && /top|left/.test(a) && (a = "0%");
                        return a
                    }

                    function o(a, b, c) {
                        g.isTruthy(a, "element not specified"), g.isString(b), b = b.replace(/-(\w)/g, function (a, b) {
                            return b.toUpperCase()
                        }), a.style[b] = c
                    }
                    ...
                    function p(a, b) {
                        __p && __p();
                        var c = !0;
                        for (var d = 0, e; e = b[d++];) e in j || (c = !1, j[e] = !0);
                        if (c) return;
                        if (h.ie() < 11) try {
                            document.createStyleSheet().cssText = a
                        } catch (b) {
                            document.styleSheets[0] && (document.styleSheets[0].cssText += a)
                        } else {
                    ...
                    function q(a) {
                        if (!a || !a.parentNode) return null; else return a.parentNode.removeChild(a)
                    }
                    ...
                    function r() {
                        ...
                        return {
                            ...
                            height: window.innerHeight ? window.innerHeight : a.clientHeight
                        }
                    }
                ...
                __d("sdk.ErrorHandler", ["ManagedError", "normalizeError", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                    ...
                    function a(a, b) {
                        ...
                        function e(b, e) {
                            ...
                            return function () {
                                ...
                                try {
                                    ...
                                    var f = h(a);
                                    f.entry = e;
                                    var i = ES(Array.prototype.slice.call(arguments), "map", !0, function (a) {
                        ...
                        function k(a, b) {
                            return function (d, e) {
                                var f = b + ":" + (c || "[global]") + ":" + (d.name || "[anonymous]" + j(arguments));
                                return a(i(d, "entry", f), e)
                            }
                        }

                        a && (setTimeout = k(setTimeout, "setTimeout"), setInterval = k(setInterval, "setInterval"), i.setWrapper(e, "entry"));
                        return {guard: e, unguard: f}
                    }

                    e.exports = {create: a}
                }), null);
                __d("sdk.ErrorHandling", ["sdk.ErrorHandler", "sdk.Runtime", "sdk.Scribe", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j) {
                    a = j("error_handling", !1);
                    e.exports = g.create(a, function (a) {
                        i.log("jssdk_error", {appId: h.getClientID(), error: a.name || a.message, extra: a})
                    })
                }), null);
                ...
                __d("FB", ["sdk.Auth", "JSSDKCssConfig", "dotAccess", "sdk.domReady", "sdk.DOM", "sdk.ErrorHandling", "sdk.Content", "DOMWrapper", "GlobalCallback", "sdk.Insights", "Log", "sdk.Runtime", "sdk.Scribe", "JSSDKConfig"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
                    __p && __p();
                    var u = void 0, v = void 0, w = i(t, "api.mode"), x = {};
                    u = window.FB = {};
                    b = {};
                    q.level = 0;
                    ...
                    n.setRoot(y);
                    j(function () {
                        q.info("domReady"), m.appendHidden(y), h.rules && k.addCssRules(h.rules, h.components)
                    });
                    r.subscribe("AccessToken.change", function (a) {
                        !a && r.getLoginStatus() === "connected" && g.getLoginStatus(null, !0)
                    });
                    i(t, "api.whitelist.length") && (v = {}, ES(t.api.whitelist, "forEach", !0, function (a) {
                        v[a] = 1
                    }));
                    ...
                    function z(a, b, c, d) {
                        ...
                        switch (e) {
                            ...
                            case"stub":
                                return function () {
                                    q.warn("The method FB.%s has been removed from the JS SDK.", b)
                                };
                            default:
                                return l.guard(function () {
                                    __p && __p();
                                    e === "warn" && (q.warn("The method FB.%s is not officially supported by Facebook and access to it will soon be removed.", b), Object.prototype.hasOwnProperty.call(x, b) || (p.log(p.TYPE.WARNING, p.CATEGORY.DEPRECATED, "FB." + b), s.log("jssdk_error", {
                                        appId: r.getClientID(),
                                    ...
                                    function f(a) {
                                        ...
                                        return a && typeof a === "object" && a.__wrapped ? a.__wrapped : typeof a === "function" && /^function/.test(a.toString()) ? l.unguard(a) : a
                                    }

                                    var g = ES(Array.prototype.slice.call(arguments), "map", !0, f), h = a.apply(d, g),
                                        i, j = !0;
                                    if (h && typeof h === "object") {
                                        ...
                                        for (var c in h) {
                                            var k = h[c];
                                            if (typeof k !== "function" || c === "constructor") continue;
                                            j = !1;
                                            i[c] = z(k, b + ":" + c, c, h)
                                        }
                                    }
                    ...
                    r.setSecure(function () {
                        var a = /iframe_canvas|app_runner/.test(window.name), b = /dialog/.test(window.name);
                        if (location.protocol == "https:" && (window == top || !(a || b))) return !0;
                        if (/_fb_https?/.test(window.name)) return ES(window.name, "indexOf", !0, "_fb_https") != -1
                    }());
                ...
                __d("flattenObject", [], (function (a, b, c, d, e, f) {
                    ...
                    function a(a) {
                        ...
                        for (var c in a) if (Object.prototype.hasOwnProperty.call(a, c)) {
                            var d = a[c];
                            if (null === d || undefined === d) continue; else typeof d == "string" ? b[c] = d : b[c] = ES("JSON", "stringify", !1, d)
                        }
                        return b
                    }
                ...
                __d("ApiClientUtils", ["ArgumentError", "Assert", "Log", "sdk.URI", "flattenObject", "sprintf"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    ...
                    function a(a) {
                        ...
                        h.isTrue(Object.prototype.hasOwnProperty.call(m, a), l("Invalid method passed to ApiClient: %s", a));
                        var d = c["function"];
                        d || i.warn("No callback passed to the ApiClient");
                        c.object && b.addQueryData(k(c.object));
                ...
                __d("nullthrows", [], (function (a, b, c, d, e, f) {
                    a = function (a) {
                        var b = arguments.length <= 1 || arguments[1] === undefined ? "Got unexpected null or undefined" : arguments[1];
                        if (a != null) return a;
                        var c = new Error(b);
                        c.framesToPop = 1;
                        throw c
                ...
                __d("sdk.safelyParseResponse", ["errorCode", "nullthrows"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    function a(a) {
                        var c = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
                        try {
                ...
                __d("ApiBatcher", ["ApiClientUtils", "QueryString", "invariant", "sdk.safelyParseResponse"], (function (a, b, c, d, e, f, g, h, i, j) {
                    "use strict";
                    __p && __p();
                    var k = 50, l = 105440539523;
                    ...
                    m.prototype.scheduleBatchCall = function () {
                        ...
                        var d = m.prepareBatchParams(b), e = d.body, f = d.callback, g = d.method, h = d.relative_url,
                            i = {method: g, relative_url: h};
                        e && (i.body = e);
                        this.$1.push(i);
                        this.$2.push(f);
                        this.$1.length == k ? (this.$4 && clearTimeout(this.$4), this.$5()) : this.$4 || (this.$4 = setTimeout(ES(function () {
                            this.$5()
                        }, "bind", !0, this), 0))
                    };
                    m.prepareBatchParams = function (a) {
                        a = g.parseCallDataFromArgs(a);
                        var b = a.uri, c = a.callback;
                        a = a.params.method;
                        var d, e = b.removeQueryData("method").toString();
                        a.toLowerCase() == "post" && (d = h.encode(b.getQueryData()), e = b.setQueryData({}).toString());
                    ...
                    m.prototype.$5 = function () {
                        ...
                        var a = this.$1, b = this.$2;
                        this.$1 = [];
                        this.$2 = [];
                        this.$4 = null;
                        if (a.length === 1) {
                            var c = a[0], d = b[0], e = c.body ? h.decode(c.body) : null;
                        ...
                        this.executeRequest("/", "POST", {
                            batch: a,
                            include_headers: !1,
                            batch_app_id: this.$3 || l
                        }, function (a) {
                            ES("Array", "isArray", !1, a) ? ES(a, "forEach", !0, function (a, c) {
                                b[c](j(a && a.body))
                ...
                __d("CORSRequest", ["wrapFunction", "QueryString", "RequestConstants", "sdk.safelyParseResponse"], (function (a, b, c, d, e, f, g, h, i, j) {
                    __p && __p();

                    function k(a, b) {
                        __p && __p();
                        if (!self.XMLHttpRequest) return null;
                        var c = new XMLHttpRequest(), d = function () {
                        };
                        if ("withCredentials" in c) c.open(a, b, !0), c.setRequestHeader("Content-type", "application/x-www-form-urlencoded"); else if (self.XDomainRequest) {
                        ...
                        }, "entry", "XMLHttpRequest:load"), h = g(function () {
                            h = d, "onerror" in e && e.onerror(c)
                        ...
                        c.onreadystatechange = function () {
                            c.readyState == 4 && (c.status == 200 ? f() : h())
                        };
                        return e
                    }
                    ...
                    function a(a, b, c, d) {
                        ...
                        if (!b) return !1;
                        b.onload = function (b) {
                            d(j(b.responseText, a))
                        };
                        b.onerror = function (b) {
                            b.responseText ? d(j(b.responseText, a)) : d({error: babelHelpers["extends"]({}, i.PARSE_ERROR_TEMPLATE, {status: b.status})})
                        };
                        b.send(c);
                        return !0
                    }
                ...
                __d("GraphBatchConstants", [], (function (a, b, c, d, e, f) {
                    e.exports = ES("Object", "freeze", !1, {FLUSH_DELIMITER: "\r\n"})
                }), null);
                __d("ChunkedRequest", ["GraphBatchConstants", "QueryString", "RequestConstants", "sdk.safelyParseResponse", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    var l = "{}";

                    function m() {
                        var a = arguments.length <= 0 || arguments[0] === undefined ? g.FLUSH_DELIMITER : arguments[0];
                        this.offset = 0;
                    ...
                    m.prototype.parse = function (a) {
                        __p && __p();
                        var b = arguments.length <= 1 || arguments[1] === undefined ? !1 : arguments[1], c = [],
                            d = a.substring(this.offset), e = 0, f = ES(d, "indexOf", !0, this.delimiter, e);
                    ...
                    function n(a, b) {
                        ...
                        }, "entry", "XMLHttpRequest:onchunk"), g = k(function () {
                            e.onerror && e.onerror(c)
                        }, "entry", "XMLHttpRequest:error");
                        c.onerror = g;
                        c.onreadystatechange = function () {
                            c.readyState == 4 ? c.status === 200 ? f(c.responseText, !0) : g() : c.readyState == 3 && f(c.responseText, !1)
                        };
                        return e
                    }
                    ...
                    function a(a, b, c, d) {
                        ...
                        b.onerror = function (a) {
                            a.responseText ? d(j(a.responseText)) : d({error: babelHelpers["extends"]({}, i.PARSE_ERROR_TEMPLATE, {status: a.status})})
                        };
                        b.send(c);
                        return !0
                    }
                ...
                __d("FlashRequest", ["DOMWrapper", "Flash", "GlobalCallback", "QueryString", "Queue"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function p() {
                        ...
                        var a = i.create(function () {
                            ...
                            try {
                                ...
                                d = {error: {type: "SyntaxError", message: a.message, status: b, raw: c}}
                            }
                            m[a](d);
                            delete m[a]
                        });
                        o = h.embed(n, g.getRoot(), null, {log: !1, initCallback: a, requestCallback: b})
                    }
                    ...
                    function a(a, b, c, d) {
                        ...
                        c.method || (c.method = b);
                        c = j.encode(c);
                        b === "get" && a.length + c.length < 2e3 ? (a = j.appendToUrl(a, c), c = "") : b = "post";
                        if (!l) {
                ...
                __d("JSONPRequest", ["DOMWrapper", "GlobalCallback", "QueryString"], (function (a, b, c, d, e, f, g, h, i) {
                    ...
                    function a(a, b, c, d) {
                        __p && __p();
                        var e = document.createElement("script"), f = function (a) {
                            f = function () {
                            }, h.remove(c.callback), d(a), e.parentNode.removeChild(e)
                        };
                        ...
                        e.addEventListener ? e.addEventListener("load", l, !1) : e.onreadystatechange = function () {
                    ...
                    c = {execute: a, ignoreMaxQuerystringLength: b, MAX_QUERYSTRING_LENGTH: j};
                    e.exports = c
                }), null);
                __d("ApiClient", ["ApiBatcher", "ApiClientUtils", "Assert", "ChunkedRequest", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "UrlMap", "ApiClientConfig"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
                    __p && __p();
                    var t, u, v, w = n.MAX_QUERYSTRING_LENGTH, x = {
                        fql_query: !0,
                        fql_multiquery: !0,
                        friends_get: !0,
                        notifications_get: !0,
                        stream_get: !0,
                        users_getinfo: !0
                    }, y = ["cors", "jsonp", "flash"], z = 0, A = [], B = 0, C = 0, D;
                    ...
                    function E(a, b, c, d) {
                        ...
                        c.pretty = c.pretty || 0;
                        c = m(c);
                        e = {jsonp: n, cors: k, flash: l, chunked: j};
                        var f = {}, g = c.access_token || t;
                        g && (f.access_token = g);
                        g = ES("Object", "keys", !1, f);
                        g.length > 0 && (a = q.appendToUrl(a, f), ES(g, "forEach", !0, function (a) {
                            return delete c[a]
                        }));
                        c.transport ? (f = [c.transport], delete c.transport) : f = y;
                        for (var g = 0; g < f.length; g++) {
                            var h = e[f[g]], i = ES("Object", "assign", !1, {}, c);
                            if (h.execute(a, b, i, d)) return
                        }
                        d({error: {type: "no-transport", message: "Could not find a usable transport for request"}})
                    }
                    ...
                    function F(a, b, c, d, e, f, g, h) {
                        ...
                        g && g.error && H.inform("request.error", b, c, d, g, ES("Date", "now", !1) - e, f);
                        H.inform("request.complete", b, c, d, g, ES("Date", "now", !1) - e, f);
                        z--;
                        a && a(g);
                        h = A.length > 0 && z < B;
                        if (h) {
                    ...
                    function G() {
                        for (var a = arguments.length, b = Array(a), c = 0; c < a; c++) b[c] = arguments[c];
                        var d = h.parseCallDataFromArgs(b), e = d.uri, f = d.callback, g = d.params, i = g.method;
                        I(e, i) && (i = "post");
                        var j = e.getProtocol() && e.getDomain() ? e.setQueryData({}).toString() : r.resolve("graph") + e.getPath(),
                            k = C++;
                        H.inform("request.prepare", j, g, k);
                        E(j, i == "get" ? "get" : "post", g, ES(F, "bind", !0, null, f, e.getPath(), i, g, ES("Date", "now", !1), k))
                    }
                    ...
                    function b(a, b) {
                        ...
                        var d = C++;
                        b = ES(F, "bind", !0, null, b, "/restserver.php", "get", a, ES("Date", "now", !1), d);
                        E(c, "get", a, b)
                    }
                    ...
                    var H = ES("Object", "assign", !1, new p(), {
                        setAccessToken: function (a) {
                            ...
                            return A.length
                        }, rest: b, graph: G, scheduleBatchCall: a, prepareBatchParams: g.prepareBatchParams
                    });
                ...
                __d("sdk.PlatformVersioning", ["sdk.Runtime", "ManagedError"], (function (a, b, c, d, e, f, g, h) {
                    var i = /^v\d+\.\d\d?$/;
                    a = {
                        REGEX: i, assertVersionIsSet: function () {
                            if (!g.getVersion()) throw new h("init not called with valid version")
                        }, assertValidVersion: function (a) {
                            if (!i.test(a)) throw new h("invalid version specified")
                        }
                    };
                    e.exports = a
                }), null);
                __d("sdk.api", ["ApiClient", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    var m = l("should_log_response_error", !1), n;
                    i.subscribe("ClientID.change", function (a) {
                        return g.setClientID(a)
                    });
                    i.subscribe("AccessToken.change", function (a) {
                        n = a, g.setAccessToken(a)
                    });
                    g.setDefaultParams({sdk: "joey"});
                    g.subscribe("request.complete", function (a, b, c, d) {
                        a = !1;
                        d && typeof d == "object" && (d.error ? (d.error == "invalid_token" || d.error.type == "OAuthException" && d.error.code == 190) && (a = !0) : d.error_code && (d.error_code == "190" && (a = !0)));
                        a && n === i.getAccessToken() && i.setAccessToken(null)
                    });
                    g.subscribe("request.complete", function (a, b, c, d) {
                        (a == "/me/permissions" && b === "delete" || a == "/restserver.php" && c.method == "Auth.revokeAuthorization") && d === !0 && i.setAccessToken(null)
                    });
                    g.subscribe("request.error", function (a, b, c, d) {
                        m && d.error.type === "http" && j.log("jssdk_error", {
                            appId: i.getClientID(),
                            error: "transport",
                            extra: {name: "transport", message: ES("JSON", "stringify", !1, d.error)}
                        })
                    });

                    function a(a) {
                        __p && __p();
                        if (typeof a === "string") if (i.getIsVersioned()) {
                            h.assertVersionIsSet();
                            !/https?/.test(a) && a.charAt(0) !== "/" && (a = "/" + a);
                            a = new k(a).setDomain(null).setProtocol(null).toString();
                            h.REGEX.test(a.substring(1, ES(a, "indexOf", !0, "/", 1))) || (a = "/" + i.getVersion() + a);
                            var b = [a].concat(Array.prototype.slice.call(arguments, 1));
                            g.graph.apply(g, b)
                        } else g.graph.apply(g, arguments); else g.rest.apply(g, arguments)
                    }
                ...
                __d("FBEventsParamList", [], (function (a, b, c, d, e, f) {
                    ...
                    function i(a) {
                        if (typeof JSON === "undefined" || JSON === null || !ES("JSON", "stringify", !1)) return Object.prototype.toString.call(a); else return ES("JSON", "stringify", !1, a)
                    }
                ...
                __d("FBEventsUtils", [], (function (a, b, c, d, e, f) {
                    "use strict";
                    __p && __p();
                    var g = "console", h = "error", i = "Facebook Pixel Error", j = "Facebook Pixel Warning",
                        k = "warn", l = Object.prototype.toString, m = !("addEventListener" in document),
                        n = function () {
                        }, o = window[g] || {}, p = window.postMessage || n;
                    ...
                    function b(a) {
                        p({action: "FB_LOG", logType: i, logMessage: a}, "*"), h in o && o[h](i + ": " + a)
                    }

                    function c(a) {
                        p({action: "FB_LOG", logType: j, logMessage: a}, "*"), k in o && o[k](j + ": " + a)
                    }

                    function d(a, b, c) {
                        b = m ? "on" + b : b;
                        var d = m ? "attachEvent" : "addEventListener", e = m ? "detachEvent" : "removeEventListener",
                            f = function d() {
                                a[e](b, d, !1), c()
                            };
                        a[d](b, f, !1)
                ...
                __d("FBPixelEndpoint", ["FBEventsParamList", "FBEventsUtils"], (function (a, b, c, d, e, f, g, h) {
                    "use strict";
                    __p && __p();
                    var i = "https://www.facebook.com/tr/", j = location.href, k = window.top !== window,
                        l = document.referrer;
                    ...
                    function m(a, b, c, d) {
                        ...
                        e.append("cd", c);
                        e.append("sw", window.screen.width);
                        e.append("sh", window.screen.height);
                        for (var f in d) e.append(f, d[f]);
                        return e
                    }
                    ...
                    function o(a, b) {
                        __p && __p();
                        var c = "fb" + Math.random().toString().replace(".", ""), d = document.createElement("form");
                        d.method = "post";
                        d.action = a;
                        d.target = c;
                ...
                __d("FBAppEvents", ["ApiClient", "FBPixelEndpoint"], (function (a, b, c, d, e, f, g, h) {
                    "use strict";
                    __p && __p();

                    function a(a, b, c, d, e) {
                        var f = {};
                        d != null && (f.vts = d.toString());
                        e != null && (f.at = e);
                        h.sendEvent(a.toString(), b, c, f)
                    }

                    function b(a, b, c, d) {
                        b = "/" + b + "/user_properties";
                        a = {data: [{user_unique_id: a, custom_data: c}]};
                        g.graph(b, "post", a, d)
                    }

                    e.exports = {logEvent: a, updateUserProperties: b}
                }), null);
                __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "sdk.Event", "sdk.Impressions", "sdk.Model", "sdk.Runtime", "FBAppEvents", "sdk.Auth"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    var o = ES("Object", "freeze", !1, {
                        ...
                        }), r = /^[0-9a-zA-Z_][0-9a-zA-Z _-]{0,39}$/, s = 40, t = r, u = s, v = 100, w = 100, x = 100,
                        y = 100, z = ES("Object", "values", !1, g), A = new k({UserID: "", Version: ""});

                    function B(a, b, c, d) {
                        b = {ae: 1, ev: b, vts: c, canvas: 1};
                        d && (b.cd = d);
                        j.impression({api_key: a, payload: ES("JSON", "stringify", !1, b)})
                    }

                    function C(a, b, c, d) {
                        var e = n.getAuthResponse();
                        e = e && e.accessToken ? e.accessToken : null;
                        m.logEvent(a, b, d || {}, c, e)
                    }

                    function D(a, b, c, d) {
                        E(b);
                        var e = A.getUserID();
                        e !== "" && (d = d || {}, d[q.APP_USER_ID] = e);
                        e = A.getVersion();
                        e !== "" && (d = d || {}, d[q.APP_VERSION] = e);
                        l.isCanvasEnvironment() ? B(a, b, c, d) : C(a, b, c, d)
                    }

                    function E(a) {
                        h.isTrue(r.test(a), "Invalid event name: " + a + ". It must be between 1 and " + s + " characters, and must be contain only alphanumerics, _, - or spaces, starting with alphanumeric or _.")
                    }

                    function a(a, b, c, d) {
                        var e = {};
                        e[q.CURRENCY] = c;
                        D(a, p.PURCHASED, b, babelHelpers["extends"]({}, d, e))
                    }
                    ...
                    function G(a) {
                        h.isTrue(a.length !== 0, "User ID must be set before updateUserProperties can be called."), h.isTrue(a.length <= v, "Invalid user ID: " + a + ". It must be no longer than " + v + " characters.")
                    }
                    ...
                    function I(a) {
                        h.isTrue(a.length <= w, "Invalid app version: " + a + ". It must be no longer than " + w + " characters.")
                    }
                    ...
                    function M(a, b, c) {
                        ...
                        G(d);
                        L(b);
                        m.updateUserProperties(d, a, b, c)
                    }

                    i.subscribe("init:post", function (a) {
                        l.getClientID() && (a.autoLogAppEvents !== undefined && (h.isBoolean(a.autoLogAppEvents, "Type of property autoLogAppEvents must be boolean"), l.setAutoLogAppEvents(a.autoLogAppEvents)), l.getAutoLogAppEvents() && F(l.getClientID()))
                    });
                    e.exports = {
                        activateApp: b,
                        logEvent: D,
                        ...
                        getUserID: H,
                        clearUserID: d,
                        assertValidUserProperties: L,
                        updateUserProperties: M,
                        setAppVersion: f,
                        getAppVersion: J,
                        clearAppVersion: K,
                        assertValidAppVersion: I
                    }
                }), null);
                __d("legacy:fb.appevents", ["Assert", "sdk.AppEvents", "FB", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j) {
                    __p && __p();

                    function k() {
                        var a = j.getClientID();
                        g.isTrue(a !== null && a.length > 0, "You need to call FB.init() with App ID first.");
                        return a
                    }
                    ...
                    i.provide("AppEvents", {
                        logEvent: function (a, b, c) {
                            h.logEvent(k(), a, b, c)
                        }, logPurchase: function (a, b, c) {
                            h.logPurchase(k(), a, b, c)
                            ...
                            h.clearUserID()
                        }, updateUserProperties: function (a, b) {
                            h.updateUserProperties(k(), a, b)
                            ...
                            h.clearAppVersion()
                        }, EventNames: h.EventNames, ParameterNames: h.ParameterNames
                    })
                }), 3);
                ...
                __d("sdk.DialogUtils", ["sdk.Content", "sdk.DOM", "DOMEventListener", "sdk.UA", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    "use strict";
                    __p && __p();
                    a = {
                        isOrientationPotrait: function () {
                            ...
                            return i.add(a, "click", function () {
                                d !== null && (clearTimeout(d), d = null, b()), d = setTimeout(function () {
                                    d = null
                                }, c)
                            })
                        }, addIdleDesktopAction: function (a, b, c) {
                            var d = void 0, event = void 0, e = function () {
                                d = setTimeout(b, c)
                            };
                            e();
                            return i.add(a, "mouseenter", function () {
                                clearTimeout(d), event || (event = i.add(a, "mouseleave", function () {
                                    e()
                                }))
                            })
                            ...
                            a.style.minHeight = b.height || b.width ? b.height + "px" : "";
                            a.style.top = b.scrollTop ? b.scrollTop + "px" : ""
                        }, setDialogPositionToCenter: function (a, b, c) {
                            __p && __p();
                            var d = function (a) {
                                return typeof a === "number" ? a : parseInt(a, 10)
                            }, e = h.getViewportInfo(), f = d(a.offsetWidth);
                            d = d(a.offsetHeight);
                            f = e.scrollLeft + (e.width - f) / 2;
                            var g = (e.height - d) / 2.5;
                            f < g && (g = f);
                            var i = e.height - d - g, l = (e.height - d) / 2;
                            c && (l = c.scrollTop - c.offsetTop + (c.clientHeight - d) / 2);
                            l < g ? l = g : l > i && (l = i);
                            l += e.scrollTop;
                            if (j.mobile()) {
                                c = 100;
                                b ? (c += (e.height - d) / 2, h.addCss(document.body, "fb_reposition")) : (h.addCss(document.body, "fb_hidden"), k("dialog_resize_refactor", !1) && (document.body.style.width = "auto"), l = 1e4);
                                g = h.getByClass("fb_dialog_padding", a);
                                g.length && (g[0].style.height = c + "px")
                            }
                            a.style.left = (f > 0 ? f : 0) + "px";
                            a.style.top = (l > 0 ? l : 0) + "px"
                        }, setDialogPositionToTop: function (a, b, c) {
                            this.setDialogPositionToCenter(a, b, c);
                            b = h.getViewportInfo();
                            c = b.scrollTop + (b.height - a.offsetHeight) * .05;
                            ...
                            __p && __p();
                            a = a || {};
                            var b = document.createElement("div"), c = a;
                            c = c.onClose;
                            if (a.closeIcon && c) {
                            ...
                            var b = document.body;
                            a ? h.removeCss(b, "fb_reposition") : h.removeCss(b, "fb_hidden")
                        }
                    };
                    e.exports = a
                }), null);
                ...
                __d("sdk.Dialog", ["sdk.Canvas.Environment", "sdk.Content", "sdk.DialogUtils", "sdk.DOM", "DOMEventListener", "ObservableMixin", "sdk.Runtime", "Type", "sdk.UA", "sdk.fbt", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    __p && __p();
                    var r = 30, s = 590, t = 500, u = 240, v = 575;

                    function w() {
                        if (q("dialog_resize_refactor", !1)) {
                            var a = j.getViewportInfo();
                            if (a.height && a.width) return {width: Math.min(a.width, t), height: Math.min(a.height, s)}
                        }
                        return null
                    }
                    ...
                    var x = n.extend({
                        constructor: function (a, b) {
                            this.parent(), this.id = a, this.display = b, this._e2e = {}, y._dialogs || (y._dialogs = {}, y._addOrientationHandler()), y._dialogs[a] = this, this.trackEvent("init")
                        ...
                        _findRoot: function (a) {
                            while (a) {
                                if (j.containsCss(a, "fb_dialog")) return a;
                                a = a.parentNode
                            }
                        },
                        ...
                        _createMobileLoader: function () {
                            var a;
                            o.nativeApp() ? a = '<div class="dialog_header"></div>' : y.isTabletStyle() ? a = '<div class="overlayLoader"><div id="fb_dialog_loader_spinner"></div><a id="fb_dialog_loader_close" href="#">' + p._("Cancel") + "</a></div>" : a = '<div class="dialog_header"><table>  <tbody>    <tr>      <td class="header_left">        <label class="touchable_button">          <input type="submit" value="' + p._("Cancel") + '"            id="fb_dialog_loader_close"/>        </label>      </td>      <td class="header_center">        <div>         ' + p._("Loading...") + '        </div>      </td>      <td class="header_right">      </td>    </tr>  </tbody></table></div>';
                            return y.create({classes: "loading" + (y.isTabletStyle() ? " centered" : ""), content: a})
                        },
                        _setDialogOverlayStyle: function () {
                            i.applyScreenDimensions(y._overlayEl)
                        },
                        _showTabletOverlay: function (a) {
                            if (!y.isTabletStyle()) return;
                            y._overlayEl || (y._overlayEl = i.setupNewDarkOverlay(), h.append(y._overlayEl, null));
                            if (y._closeOnOverlayTap) {
                                a = i.addDoubleClickAction(y._overlayEl, ES(a, "bind", !0, this), 5e3);
                                y._overlayListeners.push(a)
                            }
                            y._overlayEl.className = ""
                        },
                        _hideTabletOverlay: function () {
                            y.isTabletStyle() && (y._overlayEl.className = "hidden", ES(y._overlayListeners, "forEach", !0, function (a) {
                                return a.remove()
                            }), y._overlayListeners = [])
                        },
                        showLoader: function (a, b) {
                            ...
                            var c = function () {
                                y._hideLoader(), i.onDialogHideCleanup(y.isTabletStyle()), y._hideTabletOverlay(), a()
                            };
                            y._showTabletOverlay(c);
                            y._loaderEl || (y._loaderEl = y._findRoot(o.mobile() ? y._createMobileLoader() : y._createWWWLoader(b)));
                            b = document.getElementById("fb_dialog_loader_close");
                            if (b) {
                                j.removeCss(b, "fb_hidden");
                                b = k.add(b, "click", c);
                                y._overlayListeners.push(b)
                            }
                            y._makeActive(y._loaderEl)
                        },
                        setCloseOnOverlayTap: function (a) {
                            y._closeOnOverlayTap = !!a
                        },
                        setPositionDialogAtTopWhenPortrait: function (a) {
                            y._positionDialogAtTopWhenPortrait = !!a
                        },
                        _hideLoader: function () {
                            y._loaderEl && y._loaderEl == y._active && (y._loaderEl.style.top = "-10000px")
                        },
                        _makeActive: function (a) {
                            y._setDialogSizes(), y._lowerActive(), y._active = a, m.isEnvironment(m.ENVIRONMENTS.CANVAS) && g.getPageInfo(function (a) {
                                y._centerActive(a)
                            }), y._centerActive()
                        },
                        ...
                        _removeStacked: function (a) {
                            y._stack = ES(y._stack, "filter", !0, function (b) {
                                return b != a
                            })
                        },
                        _centerActive: function (a) {
                            var b = y._active;
                            if (!b) return;
                            y._positionDialogAtTopWhenPortrait && i.isOrientationPotrait() ? i.setDialogPositionToTop(b, y.isTabletStyle(), a) : i.setDialogPositionToCenter(b, y.isTabletStyle(), a)
                        },
                        _setDialogSizes: function () {
                            var a = arguments.length <= 0 || arguments[0] === undefined ? !1 : arguments[0];
                            if (!o.mobile()) return;
                            for (var b in y._dialogs) if (Object.prototype.hasOwnProperty.call(y._dialogs, b)) {
                                var c = document.getElementById(b);
                                c && (c.style.width = y.getDefaultSize().width + "px", a || (c.style.height = y.getDefaultSize().height + "px"))
                            }
                        },
                        getDefaultSize: function () {
                            ...
                            if (o.mobile()) {
                                var a = w();
                                if (a) {
                                    j.getViewportInfo().width <= a.width && (a.width = j.getViewportInfo().width - r);
                                    j.getViewportInfo().height <= a.height && (a.height = j.getViewportInfo().height - r);
                                    return a
                                }
                                if (o.ipad()) return {width: t, height: s};
                                if (o.android()) return {width: screen.availWidth, height: screen.availHeight}; else {
                                    a = window.innerWidth;
                                    var b = window.innerHeight, c = a / b > 1.2;
                                    return {width: a, height: Math.max(b, c ? screen.width : screen.height)}
                                }
                            }
                        ...
                        _handleOrientationChange: function () {
                            __p && __p();
                            var a = q("dialog_resize_refactor", !1) ? j.getViewportInfo().width : screen.availWidth;
                            y._availScreenWidth = a;
                            if (y.isTabletStyle()) y._setDialogSizes(!0), y._centerActive(), y._setDialogOverlayStyle(); else {
                                a = y.getDefaultSize().width;
                                for (var b in y._dialogs) if (Object.prototype.hasOwnProperty.call(y._dialogs, b)) {
                                    var c = document.getElementById(b);
                        ...
                        _addOrientationHandler: function () {
                            ...
                            y._availScreenWidth = q("dialog_resize_refactor", !1) ? j.getViewportInfo().width : screen.availWidth;
                            i.addMobileOrientationChangeAction(y._handleOrientationChange)
                        },
                        create: function (a) {
                            var b = i.setupNewDialog(a);
                            h.append(b.dialogElement);
                        ...
                        show: function (a) {
                            var b = y._findRoot(a);
                            b && (y._removeStacked(b), y._hideLoader(), y._makeActive(b), y._stack.push(b), "fbCallID" in a && y.get(a.fbCallID).inform("iframe_show").trackEvent("show"))
                        },
                        hide: function (a) {
                            var b = y._findRoot(a);
                            y._hideLoader();
                            b == y._active && (y._lowerActive(), i.onDialogHideCleanup(y.isTabletStyle()), y._hideTabletOverlay(), "fbCallID" in a && y.get(a.fbCallID).inform("iframe_hide").trackEvent("hide"))
                        },
                        remove: function (a) {
                            a = y._findRoot(a);
                            if (a) {
                                var b = y._active == a;
                                y._removeStacked(a);
                                b ? (y._hideLoader(), y._stack.length > 0 ? y.show(y._stack.pop()) : (y._lowerActive(), i.onDialogHideCleanup(y.isTabletStyle()), y._hideTabletOverlay())) : y._active === null && y._stack.length > 0 && y.show(y._stack.pop());
                                setTimeout(function () {
                        ...
                        isActive: function (a) {
                            a = y._findRoot(a);
                            return a && a === y._active
                        },
                        setForceTabletStyle: function (a) {
                            y._forceTabletStyle = !!a
                        },
                        isTabletStyle: function () {
                            __p && __p();
                            if (!o.mobile()) return !1;
                            if (y._forceTabletStyle) return !0;
                            if (q("dialog_resize_refactor", !1)) {
                                var a = w();
                                a = a && (a.height >= s || a.width >= t)
                            } else a = !!o.ipad();
                            return a
                        }
                    };
                ...
                __d("sdk.NativeExtensions", ["Log", "sdk.UA", "sdk.domReady", "DOMEventListener"], (function (a, b, c, d, e, f, g, h, i, j) {
                    __p && __p();
                    var k = "fbNativeExtensionsReady";
                    ...
                    a = {
                        onReady: function (a) {
                            __p && __p();
                            if (!h.facebookInAppBrowser()) {
                                g.error("FB.NativeExtensions.onReady only works when the page is rendered in a WebView of the native Facebook app.");
                                return
                            }
                            var b = l();
                            if (b) {
                ...
                __d("sdk.Extensions", ["JSONRPC", "Queue", "sdk.UA", "sdk.NativeExtensions"], (function (a, b, c, d, e, f, g, h, i, j) {
                    "use strict";
                    __p && __p();
                    var k = new h(), l = new g(function (a) {
                        k.enqueue(a)
                    }), m = new h();
                    m.start(function (a) {
                        l.read(a)
                    ...
                    var n = null;
                    i.facebookInAppBrowser() && j.onReady(function (a) {
                        n = a, a && (function () {
                            var b = a;
                            window._FBBrowserCallbackHandler = function (a) {
                                m.enqueue(ES("JSON", "stringify", !1, a))
                            };
                            b.initializeCallbackHandler(ES("JSON", "stringify", !1, {name: "_FBBrowserCallbackHandler"}));
                            k.start(function (a) {
                                b.jsonRPC(a)
                            })
                        })()
                ...
                __d("sdk.Frictionless", ["sdk.Auth", "sdk.api", "sdk.Event", "sdk.Dialog"], (function (a, b, c, d, e, f, g, h, i, j) {
                    __p && __p();
                    var k = {
                        _allowedRecipients: {}, _useFrictionless: !1, _updateRecipients: function () {
                            k._allowedRecipients = {}, h("/me/apprequestformerrecipients", function (a) {
                                if (!a || a.error) return;
                            ...
                            k._useFrictionless = !0, g.getLoginStatus(function (a) {
                                a.status == "connected" && k._updateRecipients()
                            }), i.subscribe("auth.login", function (a) {
                            ...
                            return function (c) {
                                ...
                                c && (!b && c.frictionless && (j._hideLoader(), j._restoreBodyPosition(), j._hideIPadOverlay()), delete c.frictionless, delete c.updated_frictionless);
                                a && a(c)
                            }
                        }, isAllowed: function (a) {
                            __p && __p();
                ...
                __d("sdk.openMessenger", ["sdk.UA"], (function (a, b, c, d, e, f, g) {
                    ...
                    var h = "https://itunes.apple.com/us/app/messenger/id454638411",
                        i = "https://play.google.com/store/apps/details?id=com.facebook.orca", j = 3e3;

                    function a(a) {
                        var b = void 0, c = void 0, d = a.link;
                        a = a.app_id;
                        g.android() ? (b = "intent://share/#Intent;package=com.facebook.orca;scheme=fb-messenger;S.android.intent.extra.TEXT=" + encodeURIComponent(d) + ";S.trigger=send_plugin;", a && (b += "S.platform_app_id=" + encodeURIComponent(a) + ";"), b += "end", c = i) : (b = "fb-messenger://share?link=" + encodeURIComponent(d), a && (b += "&app_id=" + encodeURIComponent(a)), c = h);
                        setTimeout(function () {
                ...
                __d("sdk.UIServer", ["sdk.Auth", "sdk.Extensions", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Frictionless", "Log", "sdk.Native", "QueryString", "sdk.RPC", "sdk.Runtime", "JSSDKConfig", "sdk.UA", "UrlMap", "sdk.XD", "createObjectFrom", "sdk.feature", "sdk.fbt", "flattenObject", "sdk.getContextType", "guid", "insertIframe", "sdk.openMessenger", "resolveURI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E) {
                    ...
                    var F = {
                        transform: function (a) {
                            if (a.params.display === "touch" && K.canIframe(a.params) && window.postMessage) {
                                a.params.channel = K._xdChannelHandler(a.id, "parent");
                                t.nativeApp() || (a.params.in_iframe = 1);
                                return a
                            } else return K.genericTransform(a)
                        }, getXdRelation: function (a) {
                            var b = a.display;
                            return b === "touch" && window.postMessage && a.in_iframe ? "parent" : K.getXdRelation(a)
                        }
                    };
                    ...
                    a = {
                        "stream.share": {
                            size: {width: 670, height: 340}, url: "sharer.php", transform: function (a) {
                        ...
                        apprequests: {
                            transform: function (a) {
                                a = F.transform(a);
                                a.params.frictionless = m && m._useFrictionless;
                                a.params.frictionless && (m.isAllowed(a.params.to) && (a.params.display = "iframe", a.params.in_iframe = !0, a.hideLoader = !0), a.cb = m._processRequestResponse(a.cb, a.hideLoader));
                                a.closeIcon = !1;
                                return a
                            }, getXdRelation: F.getXdRelation
                        },
                        "permissions.oauth": {
                            url: "dialog/oauth",
                            size: {width: t.mobile() ? null : 475, height: t.mobile() ? null : 183},
                            transform: function (a) {
                                __p && __p();
                                if (!r.getClientID()) {
                                ...
                                if (g.getAuthResponse() && !a.params.scope && !a.params.auth_type) {
                                    n.error("FB.login() called when user is already connected.");
                                    a.cb && a.cb({status: r.getLoginStatus(), authResponse: g.getAuthResponse()});
                                    return
                                }
                                var b = a.cb, c = a.id;
                                delete a.cb;
                                var d = a.params.auth_type === "reauthenticate",
                                    e = ES("Object", "keys", !1, ES("Object", "assign", !1, a.params.response_type ? w(a.params.response_type.split(",")) : {}, {
                                        token: !0,
                                        signed_request: !0
                                    })).join(",");
                                a.params.display === "async" ? (ES("Object", "assign", !1, a.params, {
                                    ...
                                    response_type: e,
                                    domain: location.hostname
                                }), a.cb = g.xdResponseWrapper(b, g.getAuthResponse(), "permissions.oauth")) : (d && K._xdNextHandler(function (a) {
                                    b({authResponse: null, status: "not_authorized"})
                                }, c, "opener", !0), ES("Object", "assign", !1, a.params, {
                                    client_id: r.getClientID(),
                                    redirect_uri: E(K.xdHandler(b, c, "opener", g.getAuthResponse(), "permissions.oauth", !d)),
                                    origin: A(),
                                    response_type: e,
                                    domain: location.hostname
                                }));
                        ...
                        "auth.logout": {
                            url: "logout.php", transform: function (a) {
                                if (!r.getClientID()) n.error("FB.logout() called before calling FB.init()."); else if (!g.getAuthResponse()) n.error("FB.logout() called without an access token."); else {
                                    a.params.next = K.xdHandler(a.cb, a.id, "parent", g.getAuthResponse(), "logout", !0);
                                    return a
                                }
                            }
                        },
                        "login.status": {
                            url: "dialog/oauth", transform: function (a) {
                                var b = a.cb, c = a.id;
                                delete a.cb;
                                ES("Object", "assign", !1, a.params, {
                                    client_id: r.getClientID(),
                                    redirect_uri: K.xdHandler(b, c, "parent", g.getAuthResponse(), "login_status", !0),
                                    origin: A(),
                                    response_type: "token,signed_request,code",
                                    domain: location.hostname
                                });
                    ...
                    function J(a) {
                        if (!x("should_force_single_dialog_instance", !0)) return !1;
                    ...
                    var K = {
                        ...
                        genericTransform: function (a) {
                            (a.params.display == "dialog" || a.params.display == "iframe") && ES("Object", "assign", !1, a.params, {
                                display: "iframe",
                                channel: K._xdChannelHandler(a.id, "parent.parent")
                            }, !0);
                            return a
                        },
                        checkOauthDisplay: function (a) {
                            var b = a.scope || a.perms || r.getScope();
                            if (!b) return a.display;
                            b = b.split(/\s|,/g);
                            for (var c = 0; c < b.length; c++) if (!s.initSitevars.iframePermissions[ES(b[c], "trim", !0)]) return "popup";
                            return a.display
                        },
                        prepareCall: function (a, b) {
                            __p && __p();
                            var c = a.method.toLowerCase(),
                                d = Object.prototype.hasOwnProperty.call(K.Methods, c) ? ES("Object", "assign", !1, {}, K.Methods[c]) : {},
                                e = B(), f = r.getSecure() || c !== "auth.status" && c != "login.status";
                            ES("Object", "assign", !1, a, {
                                app_id: r.getClientID(),
                                locale: r.getLocale(),
                                sdk: "joey",
                                access_token: f && r.getAccessToken() || undefined
                            });
                            (c === "share" || c === "share_open_graph") && (a.mobile_iframe = t.mobile() && (a.mobile_iframe || a.iframe_test), a.mobile_iframe && (d = ES("Object", "assign", !1, {}, F)));
                            a.display = K.getDisplayMode(d, a);
                            d.url || (d.url = "dialog/" + c);
                            (d.url == "dialog/oauth" || d.url == "dialog/permissions.request") && (a.display == "iframe" || a.display == "touch" && a.in_iframe) && (a.display = K.checkOauthDisplay(a));
                            a.display == "popup" && !d.require_access_token && delete a.access_token;
                            r.getIsVersioned() && d.url.substring(0, 7) === "dialog/" && (d.url = a.version + "/" + d.url);
                            if (J(a)) {
                                if (H[c]) {
                                    var g = 'Dialog "' + c + '" is trying to run more than once.';
                                    n.warn(g);
                                    b({error_code: -100, error_message: g});
                                    return
                                }
                                b = I(b, c)
                            }
                            g = {
                                cb: b,
                                id: e,
                                size: d.size || K.getDefaultSize(),
                                url: u.resolve(a.display == "touch" ? "m" : "www", f) + "/" + d.url,
                                params: a,
                                name: c,
                                dialog: k.newInstance(e, a.display)
                            };
                            b = d.transform ? d.transform : K.genericTransform;
                            if (b) {
                                g = b(g);
                                if (!g) return
                            }
                            a.display === "touch" && a.in_iframe && (g.params.parent_height = window.innerHeight);
                            f = d.getXdRelation || K.getXdRelation;
                            c = f(g.params);
                            !(g.id in K._defaultCb) && !("next" in g.params) && !("redirect_uri" in g.params) && (g.params.next = K._xdResult(g.cb, g.id, c, !0));
                            (c === "parent" || c === "opener") && ES("Object", "assign", !1, g.params, {channel_url: K._xdChannelHandler(e, c === "parent" ? "parent.parent" : "opener")}, !0);
                            g = K.prepareParams(g);
                            return g
                        },
                        prepareParams: function (a) {
                            a.params.display !== "async" && delete a.params.method;
                            a.params.kid_directed_site = r.getKidDirectedSite() || a.params.kid_directed_site;
                            a.params = z(a.params);
                            var b = p.encode(a.params);
                            !t.nativeApp() && K.urlTooLongForIE(a.url + "?" + b) ? a.post = !0 : b && (a.url += "?" + b);
                            return a
                        },
                        urlTooLongForIE: function (a) {
                            return t.ie() && t.ie() <= 8 && a.length > 2048
                        },
                        getDisplayMode: function (a, b) {
                            __p && __p();
                            if (b.display === "hidden" || b.display === "none" || b.display === "native") return b.display;
                            var c = r.isEnvironment(r.ENVIRONMENTS.CANVAS) || r.isEnvironment(r.ENVIRONMENTS.PAGETAB);
                            if (c && !b.display) return "async";
                            if (G(b) && h.supportsDialog("oauth")) return "async";
                            if (t.mobile() || b.display === "touch") return "touch";
                            if ((b.display == "iframe" || b.display == "dialog") && !K.canIframe(b)) {
                                n.error('"dialog" mode can only be used when the user is connected.');
                                return "popup"
                            }
                            return a.connectDisplay && !c ? a.connectDisplay : b.display || (K.canIframe(b) ? "dialog" : "popup")
                        },
                        canIframe: function (a) {
                            if (r.getAccessToken()) return !0;
                            return t.mobile() && r.getLoggedIntoFacebook() ? !!a.mobile_iframe : !1
                        },
                        getXdRelation: function (a) {
                            a = a.display;
                        ...
                        popup: function (a) {
                            ...
                            var b = typeof window.screenX != "undefined" ? window.screenX : window.screenLeft,
                                ...
                                f = t.mobile() ? null : a.size.width, g = t.mobile() ? null : a.size.height;
                            ...
                            c.push("top=" + d);
                            c.push("scrollbars=1");
                            (a.name == "permissions.request" || a.name == "permissions.oauth") && (c.push("toolbar=0"), (!t.chrome() || t.chrome() < 59) && c.push("location=1"));
                            c = c.join(",");
                            a.post ? (e = window.open("about:blank", a.id, c), e && (K.setLoadedNode(a, e, "popup"), i.submitToTarget({
                                url: a.url,
                                target: a.id,
                                params: a.params
                            }))) : (e = window.open(a.url, a.id, c), e && K.setLoadedNode(a, e, "popup"));
                            if (!e) return;
                            a.id in K._defaultCb && K._popupMonitor()
                        },
                        ...
                        hidden: function (a) {
                            a.className = "FB_UI_Hidden", a.root = i.appendHidden(""), K._insertIframe(a)
                        },
                        iframe: function (a) {
                            __p && __p();
                            a.className = "FB_UI_Dialog";
                            a.params.mobile_iframe && (k.setForceTabletStyle(!0), k.setCloseOnOverlayTap(!0), k.setPositionDialogAtTopWhenPortrait(!0));
                            var b = function () {
                                var b = ES("JSON", "stringify", !1, {
                                    error_code: 4201,
                                    error_message: y._("User canceled the Dialog flow")
                                });
                                K._triggerDefault(a.id, b)
                            }, c = {
                                onClose: b,
                                closeIcon: a.closeIcon === undefined ? !0 : a.closeIcon,
                                classes: k.isTabletStyle() ? "centered" : ""
                            };
                            a.params.mobile_iframe && (c.styles = {"border-radius": "8px"});
                            a.root = k.create(c);
                            a.hideLoader || k.showLoader(b, a.size.width);
                            j.addCss(a.root, "fb_dialog_iframe");
                            K._insertIframe(a)
                        },
                        touch: function (a) {
                            a.params && a.params.in_iframe ? a.ui_created ? k.showLoader(function () {
                                K._triggerDefault(a.id, null)
                            }, 0) : K.iframe(a) : t.nativeApp() && !a.ui_created ? (a.frame = a.id, o.onready(function () {
                                K.setLoadedNode(a, o.open(a.url + "#cb=" + a.frameName), "native")
                            }), K._popupMonitor()) : a.ui_created || K.popup(a)
                        },
                        async: function (a) {
                            __p && __p();
                            ...
                            G(a.params) && h.supportsDialog("oauth") ? (a.params.method = "oauth", a.params.redirect_uri = a.params.next, h.remote.showDialog(a.params, b)) : q.remote.showDialog(a.params, b)
                        },
                        "native": function (a) {
                            D(a.params)
                        },
                        ...
                        _insertIframe: function (a) {
                            K._loadedNodes[a.id] = !1;
                            var b = function (b) {
                                a.id in K._loadedNodes && K.setLoadedNode(a, b, "iframe")
                            };
                            a.post ? C({
                                url: "about:blank",
                                root: a.root,
                                ...
                                onInsert: b,
                                onload: function (b) {
                                    i.submitToTarget({url: a.url, target: b.name, params: a.params})
                                }
                            }) : C({
                                url: a.url,
                                root: a.root,
                        ...
                        _handleResizeMessage: function (a, b) {
                            ...
                            v.inform("resize.ack", b || {}, "parent.frames[" + a.name + "]");
                            !k.isActive(a) ? k.show(a) : k._centerActive()
                        },
                        _triggerDefault: function (a, b) {
                            var c = {frame: a};
                            b && (c.result = b);
                            K._xdRecv(c, K._defaultCb[a] || function () {
                            })
                        },
                        _popupMonitor: function () {
                            __p && __p();
                            var a;
                            for (var b in K._loadedNodes) if (Object.prototype.hasOwnProperty.call(K._loadedNodes, b) && b in K._defaultCb) {
                                var c = K._loadedNodes[b];
                                if (c.type != "popup" && c.type != "native") continue;
                                c = c.node;
                                try {
                                    c.closed ? K._triggerDefault(b, null) : a = !0
                                } catch (a) {
                                }
                            }
                            a && !K._popupInterval ? K._popupInterval = setInterval(K._popupMonitor, 100) : !a && K._popupInterval && (clearInterval(K._popupInterval), K._popupInterval = null)
                        },
                        _xdChannelHandler: function (a, b) {
                            __p && __p();
                            return v.handler(function (b) {
                                __p && __p();
                                var c = K.getLoadedNode(a);
                                if (!c) return;
                                if (b.type == "resize") K._handleResizeMessage(a, b); else if (b.type == "hide") k.hide(c); else if (b.type == "rendered") {
                                    c = k._findRoot(c);
                                    k.show(c)
                                } else b.type == "fireevent" && l.fire(b.event, b)
                            }, b, !0, null)
                        },
                        ...
                        _xdRecv: function (a, b) {
                            __p && __p();
                            var c = K.getLoadedNode(a.frame);
                            if (c) if (c.close) try {
                                c.close(), /iPhone.*Version\/(5|6)/.test(navigator.userAgent) && RegExp.$1 !== "5" && window.focus(), K._popupCount--
                            } catch (a) {
                            } else j.containsCss(c, "FB_UI_Hidden") ? setTimeout(function () {
                                c.parentNode.parentNode.removeChild(c.parentNode)
                            }, 3e3) : j.containsCss(c, "FB_UI_Dialog") && k.remove(c);
                            delete K._loadedNodes[a.frame];
                            delete K._defaultCb[a.frame];
                            if (a.e2e) {
                                var d = k.get(a.frame);
                                d.trackEvents(a.e2e);
                                d.trackEvent("close");
                        ...
                        _xdResult: function (a, b, c, d) {
                            return K._xdNextHandler(function (b) {
                                a && a(b.result && b.result != K._resultToken && ES("JSON", "parse", !1, b.result))
                            }, b, c, d) + "&result=" + encodeURIComponent(K._resultToken)
                        },
                        xdHandler: function (a, b, c, d, e, f) {
                            return K._xdNextHandler(g.xdResponseWrapper(a, d, e), b, c, f)
                        }
                    };
                    h.stub("showDialog");
                    q.stub("showDialog");
                ...
                __d("sdk.ui", ["Assert", "sdk.Impressions", "Log", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UIServer", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    function a(a, b) {
                        ...
                        g.isObject(a);
                        g.maybeFunction(b);
                        k.getIsVersioned() && (j.assertVersionIsSet(), a.version ? j.assertValidVersion(a.version) : a.version = k.getVersion());
                        a = ES("Object", "assign", !1, {}, a);
                        if (!a.method) {
                        ...
                        var c = a.method;
                        a.redirect_uri && (i.warn("When using FB.ui, you should not specify a redirect_uri."), delete a.redirect_uri);
                        (c == "permissions.request" || c == "permissions.oauth") && (a.display == "iframe" || a.display == "dialog") && (a.display = l.checkOauthDisplay(a));
                        if (a.display === "native" && c !== "send") {
                            i.error('display type "native" not supported');
                            return null
                        }
                        var d = m("e2e_tracking", !0);
                        d && (a.e2e = {});
                        a = l.prepareCall(a, b || function () {
                        });
                        if (!a) return null;
                        var e = a.params.display;
                        e === "dialog" ? e = "iframe" : e === "none" && (e = "hidden");
                        b = l[e];
                        if (!b) {
                            i.error('"display" must be one of "popup", "dialog", "iframe", "touch", "async", "hidden", or "none"');
                            return null
                        }
                        d && a.dialog.subscribe("e2e:end", function (a) {
                            a.method = c, a.display = e, i.debug("e2e: %s", ES("JSON", "stringify", !1, a)), h.log(114, {payload: a})
                        });
                        b(a);
                        return a.dialog
                    }
                ...
                __d("legacy:fb.auth", ["sdk.Auth", "sdk.Cookie", "sdk.Event", "FB", "Log", "sdk.Runtime", "sdk.SignedRequest", "sdk.ui"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    __p && __p();
                    j.provide("", {
                        getLoginStatus: function () {
                            ...
                            b && b.perms && !b.scope && (b.scope = b.perms, delete b.perms, k.warn("OAuth2 specification states that 'perms' should now be called 'scope'.  Please update."));
                            var c = l.isEnvironment(l.ENVIRONMENTS.CANVAS) || l.isEnvironment(l.ENVIRONMENTS.PAGETAB);
                    ...
                    }), g.subscribe("logout", ES(i.fire, "bind", !0, i, "auth.logout")), g.subscribe("login", ES(i.fire, "bind", !0, i, "auth.login")), g.subscribe("authresponse.change", ES(i.fire, "bind", !0, i, "auth.authResponseChange")), g.subscribe("status.change", ES(i.fire, "bind", !0, i, "auth.statusChange")), i.subscribe("init:post", function (a) {
                        __p && __p();
                        a.status && g.getLoginStatus();
                        if (l.getClientID()) if (a.authResponse) g.setAuthResponse(a.authResponse, "connected"); else if (l.getUseCookie()) {
                            a = h.loadSignedRequest();
                            if (a) {
                                try {
                                    a = m.parse(a)
                                } catch (a) {
                ...
                __d("sdk.Canvas.IframeHandling", ["DOMWrapper", "sdk.RPC"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    function k() {
                        var a = g.getWindow().document, b = a.body;
                        a = a.documentElement;
                        var c = Math.max(b.offsetTop, 0), d = Math.max(a.offsetTop, 0), e = b.scrollHeight + c;
                        b = b.offsetHeight + c;
                        c = a.scrollHeight + d;
                        a = a.offsetHeight + d;
                    ...
                    function a(a, b) {
                        b === undefined && typeof a === "number" && (b = a, a = !0), a || a === undefined ? (i === null && (i = setInterval(function () {
                            l()
                        }, b || 100)), l()) : i !== null && (clearInterval(i), i = null)
                    }
                ...
                __d("sdk.Canvas.Plugin", ["Log", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.api"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    var l = "CLSID:D27CDB6E-AE6D-11CF-96B8-444553540000",
                        m = "CLSID:444785F1-DE89-4295-863A-D46C3A781394", n = null;
                    c = j.osx() && j.osx.getVersionParts();
                    var o = !(c && c[0] > 10 && c[1] > 10 && (j.chrome() >= 31 || j.webkit() >= 537.71 || j.firefox() >= 25));
                    ...
                    function t(a) {
                        ...
                        b = b === "application/x-shockwave-flash" || a.classid && a.classid.toUpperCase() == l;
                        if (!b) return !1;
                    ...
                    function u(a) {
                        var b = a.type ? a.type.toLowerCase() : null;
                        return b === "application/vnd.unity" || a.classid && a.classid.toUpperCase() == m
                    }
                    ...
                    function v(a) {
                        ...
                        if (Math.random() <= 1 / 1e3) {
                            b = {unity: d, flash: c};
                            k(i.getClientID() + "/occludespopups", "post", b)
                        }
                    }
                    ...
                    d = {
                        _setHidePluginCallback: function (a) {
                            n = a
                        }, hidePluginElement: a, showPluginElement: b
                    };
                    e.exports = d
                }), null);
                __d("sdk.Canvas.Tti", ["sdk.RPC", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h) {
                    ...
                    function i(a, b) {
                        b = {appId: h.getClientID(), time: ES("Date", "now", !1), name: b};
                        b = [b];
                        a && b.push(function (b) {
                            a(b.result)
                        });
                ...
                __d("legacy:fb.canvas", ["Assert", "sdk.Canvas.Environment", "sdk.Event", "FB", "sdk.Canvas.IframeHandling", "sdk.Canvas.Navigation", "sdk.Canvas.Plugin", "sdk.RPC", "sdk.Runtime", "sdk.Canvas.Tti"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
                    ...
                    }), n.local.fireEvent = ES(i.fire, "bind", !0, i), i.subscribe("init:post", function (a) {
                        o.isEnvironment(o.ENVIRONMENTS.CANVAS) && (g.isTrue(!a.hideFlashCallback || !a.hidePluginCallback, "cannot specify deprecated hideFlashCallback and new hidePluginCallback"), m._setHidePluginCallback(a.hidePluginCallback || a.hideFlashCallback))
                    })
                }), 3);
                __d("legacy:fb.canvas.plugin", ["FB", "sdk.Canvas.Plugin"], (function (a, b, c, d, e, f, g, h) {
                    g.provide("Canvas.Plugin", h)
                }), 3);
                __d("sdk.Canvas.Prefetcher", ["JSSDKCanvasPrefetcherConfig", "sdk.Runtime", "sdk.api"], (function (a, b, c, d, e, f, g, h, i) {
                    __p && __p();
                    var j = {AUTOMATIC: 0, MANUAL: 1}, k = g.sampleRate, l = g.blacklist, m = j.AUTOMATIC, n = [];

                    function o() {
                        var a = {object: "data", link: "href", script: "src"};
                        m == j.AUTOMATIC && ES(ES("Object", "keys", !1, a), "forEach", !0, function (b) {
                            var c = a[b];
                        ...
                        i(h.getClientID() + "/staticresources", "post", {
                    ...
                    function a() {
                        if (!h.isEnvironment(h.ENVIRONMENTS.CANVAS) || !h.getClientID() || !k) return;
                        if (Math.random() > 1 / k || l == "*" || ~ES(l, "indexOf", !0, h.getClientID())) return;
                        setTimeout(o, 3e4)
                    }
                ...
                __d("legacy:fb.canvas.prefetcher", ["FB", "sdk.Canvas.Prefetcher", "sdk.Event", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j) {
                    g.provide("Canvas.Prefetcher", h), i.subscribe("init:post", function (a) {
                ...
                __d("legacy:fb.canvas.presence", ["sdk.RPC", "sdk.Event"], (function (a, b, c, d, e, f, g, h) {
                    __p && __p();
                    h.subscribe(h.SUBSCRIBE, a);
                    h.subscribe(h.UNSUBSCRIBE, b);
                    g.stub("useFriendsOnline");

                    function a(a, b) {
                        if (a != "canvas.friendsOnlineUpdated") return;
                        b.length === 1 && g.remote.useFriendsOnline(!0)
                    }

                    function b(a, b) {
                        if (a != "canvas.friendsOnlineUpdated") return;
                        b.length === 0 && g.remote.useFriendsOnline(!1)
                    }
                }), 3);
                __d("legacy:fb.event", ["FB", "sdk.Event", "sdk.Runtime", "sdk.Scribe", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    var l = [], m = null, n = k("event_subscriptions_log", !1);
                    g.provide("Event", {
                        subscribe: function (a, b) {
                            n && (l.push(a), m || (m = setTimeout(function () {
                                j.log("jssdk_error", {
                                    appId: i.getClientID(),
                ...
                __d("sdk.MBasicInitializer", ["sdk.DOM", "sdk.Runtime", "sdk.UA", "sdk.URI", "UrlMap", "sdk.fbt", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                    var n = function () {
                        __p && __p();
                        ...
                        function a(a) {
                            ...
                            var b = a.parentNode;
                            if (!b) return;
                            var c = g.getAttr(a, "href") || window.location.href, d = new j(k.resolve("m"));
                            d.setPath("/dialog/share");
                            d.addQueryData("href", encodeURI(c));
                            d.addQueryData("app_id", h.getClientID());
                            d.addQueryData("mbasic_link", 1);
                            c = document.createElement("a");
                            c.style = "display:inline-block; zoom:1;";
                            c.textContent = l._("Share to Facebook");
                        ...
                        if (!m("js_sdk_mbasic_share_plugin_init", !1)) return;
                ...
                __d("sdk.init", ["sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "sdk.Impressions", "Log", "ManagedError", "sdk.MBasicInitializer", "sdk.PlatformVersioning", "QueryString", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
                    __p && __p();
                    ...
                    function u(a) {
                        __p && __p();
                        p.getInitialized() && k.warn("FB.init has already been called - this could indicate a problem");
                        if (p.getIsVersioned()) {
                            if (Object.prototype.toString.call(a) !== "[object Object]") throw new l("Invalid argument");
                            a.authResponse && k.warn("Setting authResponse is not supported");
                            a.version || (a.version = new r(location.href).getQueryData().sdk_version);
                            n.assertValidVersion(a.version);
                            p.setVersion(a.version)
                        } else /number|string/.test(typeof a) && (k.warn("FB.init called with invalid parameters"), a = {apiKey: a}), a = ES("Object", "assign", !1, {status: !0}, a || {});
                        var b = t(a.appId || a.apiKey);
                        b !== null && p.setClientID(b);
                        "scope" in a && p.setScope(a.scope);
                        a.cookie && (p.setUseCookie(!0), typeof a.cookie === "string" && g.setDomain(a.cookie));
                        a.kidDirectedSite && p.setKidDirectedSite(!0);
                        (a.autoLogAppEvents === "1" || a.autoLogAppEvents === "true") && (a.autoLogAppEvents = !0);
                        p.setInitialized(!0);
                        s("js_sdk_impression_on_load", !0) && j.log(115, {});
                        q.mBasic() && m.init();
                        i.fire("init:post", a)
                    }
                    ...
                    setTimeout(function () {
                        ...
                        ES(ES("Array", "from", !1, fb_fif_window.document.getElementsByTagName("script")), "forEach", !0, function (b) {
                            __p && __p();
                            if (b.src) {
                                b = a.exec(b.src);
                                if (b) {
                        ...
                        window.fbAsyncInit && !window.fbAsyncInit.hasRun && (i.fire("init:asyncstart"), window.fbAsyncInit.hasRun = !0, h.unguard(window.fbAsyncInit)())
                    }, 0);
                    e.exports = u
                }), null);
                ...
                __d("sdk.Time", ["Log", "sdk.Impressions", "sdk.Runtime", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j) {
                    "use strict";
                    __p && __p();
                    var k = window.performance, l = k && "now" in k && "getEntriesByName" in k && j("log_perf", !1),
                        m = void 0, n = {};
                    if (l) {
                        a = k.getEntriesByName(i.getSDKUrl())[0];
                        if (a) {
                            n.fetchTime = parseInt(a.duration, 10);
                            "transferSize" in a && (n.transferSize = parseInt(a.transferSize, 10));
                            g.debug("sdkperf: it took %s ms and %s bytes to load %s", parseInt(a.duration, 10), parseInt(a.transferSize, 10), i.getSDKUrl());
                            m = a.startTime;
                            n.ns = i.getSDKNS();
                            b = i.getSDKAB();
                            b && (n.ab = b);
                ...
                __d("legacy:fb.time", ["sdk.Event", "sdk.Time", "runOnce"], (function (a, b, c, d, e, f, g, h, i) {
                    "use strict";
                    g.subscribe("init:post", function () {
                        h.log("init")
                    }), g.subscribe("init:asyncstart", function () {
                        h.log("asyncstart")
                    }), g.subscribe("iframeplugin:create", i(function () {
                        return h.log("pluginframe")
                    })), g.subscribe("iframeplugin:onload", i(function () {
                        return h.log("ttfp")
                    }))
                }), 3);
                ...
                __d("XFBML", ["Assert", "sdk.DOM", "Log", "ObservableMixin", "sdk.UA", "runOnce"], (function (a, b, c, d, e, f, g, h, i, j, k, l) {
                    __p && __p();
                    var m = {}, n = {}, o = 0, p = new j();
                    ...
                    function s(a) {
                        return m[q(a, "nodeName").toLowerCase()] || m[r(a).toLowerCase()]
                    }

                    function t(a) {
                        var b = ES(q(a, "className").split(/\s+/), "filter", !0, function (a) {
                            return Object.prototype.hasOwnProperty.call(n, a)
                        });
                        if (b.length === 0) return undefined;
                        if (a.getAttribute("fb-xfbml-state") || !a.childNodes || a.childNodes.length === 0 || a.childNodes.length === 1 && a.childNodes[0].nodeType === 3 || a.children.length === 1 && q(a.children[0], "className") === "fb-xfbml-parse-ignore") return n[b[0]]
                    }
                    ...
                    function v(a, b, c) {
                        ...
                        h.addCss(a, b + "-" + c);
                        ES(ES("Array", "from", !1, a.childNodes), "forEach", !0, function (a) {
                            d.appendChild(a)
                        });
                        ES(ES("Array", "from", !1, a.attributes), "forEach", !0, function (a) {
                    ...
                    function w(a, b, c) {
                        __p && __p();
                        g.isTrue(a && a.nodeType && a.nodeType === 1 && !!a.getElementsByTagName, "Invalid DOM node passed to FB.XFBML.parse()");
                        g.isFunction(b, "Invalid callback passed to FB.XFBML.parse()");
                        var d = ++o;
                        i.info("XFBML Parsing Start %s", d);
                        var e = 1, f = 0, h = function () {
                            e--, e === 0 && (i.info("XFBML Parsing Finish %s, %s tags found", d, f), b(), p.inform("render", d, f)), g.isTrue(e >= 0, "onrender() has been called too many times")
                        };
                        ES(ES("Array", "from", !1, a.getElementsByTagName("*")), "forEach", !0, function (a) {
                            ...
                            var b = s(a) || t(a);
                            if (!b) return;
                            k.ie() < 9 && a.scopeName && (a = v(a, b.xmlns, b.localName));
                            e++;
                            f++;
                            var d = new b.ctor(a, b.xmlns, b.localName, u(a));
                            d.subscribe("render", l(function () {
                                a.setAttribute("fb-xfbml-state", "rendered"), h()
                            }));
                            b = function b() {
                                a.getAttribute("fb-xfbml-state") == "parsed" ? p.subscribe("render.queue", b) : (a.setAttribute("fb-xfbml-state", "parsed"), d.process())
                            };
                            b()
                        });
                        p.inform("parse", d, f);
                        var j = 3e4;
                        setTimeout(function () {
                            e > 0 && i.warn("%s tags failed to render in %s ms", e, j)
                        }, j);
                        h()
                    }
                    ...
                    ES("Object", "assign", !1, p, {
                        registerTag: function (a) {
                            ...
                            w(a || document.body, b || function () {
                            }, !0)
                        }, parseNew: function () {
                            w(document.body, function () {
                            }, !1)
                        }
                    });
                    e.exports = p
                }), null);
                __d("legacy:fb.xfbml", ["Assert", "sdk.Event", "FB", "XFBML", "sdk.domReady", "sdk.feature", "wrapFunction"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    __p && __p();
                    i.provide("XFBML", {
                        parse: function (a) {
                    ...
                    h.subscribe("init:post", function (a) {
                        a.xfbml && setTimeout(m(ES(k, "bind", !0, null, j.parse), "entry", "init:post:xfbml.parse"), 0)
                    });
                ...
                __d("IframePlugin", ["sdk.Auth", "sdk.DOM", "sdk.Event", "Log", "ObservableMixin", "sdk.PlatformVersioning", "QueryString", "sdk.Runtime", "Type", "sdk.UA", "sdk.URI", "UrlMap", "sdk.XD", "sdk.createIframe", "sdk.feature", "guid", "resolveURI"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
                    __p && __p();
                    var x = {
                        skin: "string",
                        font: "string",
                    ...
                    var A = {
                        string: function (a) {
                            ...
                            return /^(\d+)(?:px)?$/.test(a) ? parseInt(RegExp.$1, 10) : undefined
                        }, text: function (a) {
                            return a
                        }
                    };
                    ...
                    function B(a, b) {
                        a = a[b] || a[b.replace(/_/g, "-")] || a[b.replace(/_/g, "")] || a["data-" + b] || a["data-" + b.replace(/_/g, "-")] || a["data-" + b.replace(/_/g, "")] || undefined;
                        return a
                    }

                    function C(a, b, c, d) {
                        ES(ES("Object", "keys", !1, a), "forEach", !0, function (e) {
                            a[e] == "text" && !c[e] && (c[e] = b.textContent || b.innerText || "", b.setAttribute(e, c[e])), d[e] = A[a[e]](B(c, e))
                        })
                    }

                    function D(a) {
                        return a === "100%" ? "100%" : a || a === "0" || a === 0 ? parseInt(a, 10) : undefined
                    }
                    ...
                    var F = o.extend({
                        constructor: function (a, b, c, d) {
                            ...
                            c = c.replace(/-/g, "_");
                            var e = B(d, "plugin_id");
                            this.subscribe("xd.resize", z(e));
                            this.subscribe("xd.resize.flow", z(e));
                            this.subscribe("xd.resize.flow", ES(function (a) {
                                ES("Object", "assign", !1, this._iframeOptions.root.style, {
                                    verticalAlign: "bottom",
                                    overflow: ""
                                }), y(this._iframeOptions.root, D(a.width), D(a.height)), this.updateLift(), clearTimeout(this._timeoutID)
                            }, "bind", !0, this));
                            this.subscribe("xd.resize", ES(function (a) {
                                ES("Object", "assign", !1, this._iframeOptions.root.style, {
                                    verticalAlign: "bottom",
                                    overflow: ""
                                }), y(this._iframeOptions.root, D(a.width), D(a.height)), y(this._iframe, D(a.width), D(a.height)), this._isIframeResized = !0, this.updateLift(), clearTimeout(this._timeoutID)
                            }, "bind", !0, this));
                            this.subscribe("xd.resize.iframe", ES(function (a) {
                                a.reposition === "true" && u("reposition_iframe", !1) && this.reposition(D(a.width)), y(this._iframe, D(a.width), D(a.height)), this._isIframeResized = !0, this.updateLift(), clearTimeout(this._timeoutID)
                            }, "bind", !0, this));
                            ...
                            var f = r.resolve("www", !0) + "/plugins/" + c + ".php?", j = {};
                            C(this.getParams(), a, d, j);
                            C(x, a, d, j);
                            ES("Object", "assign", !1, j, {
                                app_id: n.getClientID(),
                                locale: n.getLocale(),
                                sdk: "joey",
                                kid_directed_site: n.getKidDirectedSite(),
                                channel: s.handler(ES(function (a) {
                                    return this.inform("xd." + a.type, a)
                                }, "bind", !0, this), "parent.parent", !0)
                            });
                            this.shouldIgnoreWidth() && (j.width = void 0);
                            j.container_width = a.offsetWidth;
                            h.addCss(a, "fb_iframe_widget");
                            var k = v();
                            this.subscribe("xd.verify", function (a) {
                                s.sendToFacebook(k, {method: "xd/verify", params: ES("JSON", "stringify", !1, a.token)})
                            });
                            this.subscribe("xd.refreshLoginStatus", ES(function () {
                                g.removeLogoutState(), g.getLoginStatus(ES(this.inform, "bind", !0, this, "login.status"), !0)
                            }, "bind", !0, this));
                            ...
                            this._iframeOptions = {
                                ...
                                url: f + m.encode(j),
                                name: k,
                                width: this._config.mobile_fullsize && p.mobile() ? void 0 : j.width || 1e3,
                                height: j.height || 1e3,
                            ...
                            this.isFluid() && j.width !== "auto" && (h.addCss(this._element, "fb_iframe_widget_fluid_desktop"), !j.width && this._config.full_width && (this._element.style.width = "100%", this._iframeOptions.root.style.width = "100%", this._iframeOptions.style.width = "100%", this._params.container_width = this._element.offsetWidth, this._iframeOptions.url = f + m.encode(this._params)))
                        }, shouldIgnoreWidth: function () {
                            return p.mobile() && this.getConfig().mobile_fullsize
                            ...
                            if (n.getIsVersioned()) {
                                ...
                                var a = new q(this._iframeOptions.url);
                                this._iframeOptions.url = a.setPath("/" + n.getVersion() + a.getPath()).toString()
                            }
                            a = ES("Object", "assign", !1, {}, this._params);
                            delete a.channel;
                            var b = m.encode(a);
                            if (this._element.getAttribute("fb-iframe-plugin-query") == b) {
                                j.info("Skipping render: %s:%s %s", this._ns, this._tag, b);
                                this.inform("render");
                                return
                            }
                            this._element.setAttribute("fb-iframe-plugin-query", b);
                            this.subscribe("render", ES(function () {
                                i.fire("iframeplugin:onload"), this._iframe.style.visibility = "visible", this._isIframeResized || E(this._iframe)
                            }, "bind", !0, this));
                            while (this._element.firstChild) this._element.removeChild(this._element.firstChild);
                            this._element.appendChild(this._iframeOptions.root);
                            var c = p.mobile() ? 120 : 45;
                            this._timeoutID = setTimeout(ES(function () {
                                E(this._iframe), j.warn("%s:%s failed to resize in %ss", this._ns, this._tag, c)
                            }, "bind", !0, this), c * 1e3);
                            this._iframe = t(this._iframeOptions);
                            i.fire("iframeplugin:create");
                            if (p.mobile() || a.width === "auto") {
                                this.useInlineHeightForMobile() && h.addCss(this._element, "fb_iframe_widget_fluid");
                                if (!this._iframeOptions.width) {
                                    ...
                                    b = {height: "auto", position: "static", width: "100%"};
                                    (p.iphone() || p.ipad()) && ES("Object", "assign", !1, b, {
                                        width: "220px",
                                        "min-width": "100%"
                                    });
                            ...
                            var b = h.getPosition(this._iframe).x, c = h.getViewportInfo().width,
                                d = parseInt(h.getStyle(this._iframe, "width"), 10), e = {};
                            if (b + a > c && b > a) this._iframe.style.left = parseInt(h.getStyle(this._iframe, "width"), 10) - a + "px", this._isRepositioned = !0, e.type = "reposition"; else if (this._isRepositioned && d - a !== 0) this._iframe.style.left = "0px", this._isRepositioned = !1, e.type = "restore"; else return;
                            s.sendToFacebook(this._iframe.name, {
                                method: "xd/reposition",
                                params: ES("JSON", "stringify", !1, e)
                            })
                        }, updateLift: function () {
                            ...
                            h[a ? "removeCss" : "addCss"](this._iframe, "fb_iframe_widget_lift")
                        }
                    }, k);
                    F.getVal = B;
                    F.withParams = function (a, b) {
                        return F.extend({
                            getParams: function () {
                                return a
                            }, getConfig: function () {
                ...
                __d("PluginTags", ["PluginAttrTypes"], (function (a, b, c, d, e, f, g) {
                    var h = {
                        ...
                        composer: {action_type: g.string, action_properties: g.string},
                        create_event_button: {},
                        group: {
                            href: g.url,
                        ...
                        messengerpreconfirmation: {messenger_app_id: g.string, page_id: g.string},
                        messengeraccountconfirmation: {messenger_app_id: g.string, page_id: g.string, state: g.string},
                        messengerbusinesslink: {messenger_app_id: g.string, page_id: g.string, state: g.string},
                        messengertoggle: {
                            messenger_app_id: g.string,
                            page_id: g.string,
                            token: g.string,
                        ...
                        send_to_mobile: {max_rows: g.string, show_faces: g.bool, size: g.string}
                ...
                __d("sdk.Arbiter", [], (function (a, b, c, d, e, f) {
                    a = {BEHAVIOR_EVENT: "e", BEHAVIOR_PERSISTENT: "p", BEHAVIOR_STATE: "s"};
                    e.exports = a
                }), null);
                __d("sdk.XFBML.Element", ["sdk.DOM", "Type", "ObservableMixin"], (function (a, b, c, d, e, f, g, h, i) {
                    ...
                    a = h.extend({
                        constructor: function (a) {
                            ...
                            a = g.getAttr(this.dom, a);
                            return a ? c ? c(a) : a : b
                        }, _getBoolAttribute: function (a, b) {
                            a = g.getBoolAttr(this.dom, a);
                            return a === null ? b : a
                            ...
                            for (var a = this.dom; a; a = a.parentNode) if (a == document.body) return !0
                        }, clear: function () {
                            g.html(this.dom, "")
                        }
                    }, i);
                ...
                __d("sdk.XFBML.IframeWidget", ["sdk.Arbiter", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Event", "sdk.XFBML.Element", "guid", "insertIframe", "QueryString", "sdk.Runtime", "sdk.ui", "UrlMap", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
                    ...
                    a = l.extend({
                        ...
                        getChannelUrl: function () {
                            if (!this._channelUrl) {
                                var a = this;
                                this._channelUrl = s.handler(function (b) {
                                    a.fire("xd." + b.type, b)
                                }, "parent.parent", !0)
                            }
                        ...
                        process: function (a) {
                            ...
                            this._visibleAfter != "immediate" ? j.addCss(this.dom, "fb_hide_iframes") : this.subscribe("iframe.onload", ES(this.fire, "bind", !0, this, "render"));
                            a = this.getSize() || {};
                            var b = this.getFullyQualifiedURL();
                            a.width == "100%" && j.addCss(this.dom, "fb_iframe_widget_fluid");
                            this.clear();
                            n({
                                url: b,
                            ...
                            this.subscribe("iframe.onload", ES(function () {
                                this.loaded = !0, this._isResizeHandled || j.addCss(this.dom, "fb_hide_iframes")
                            }, "bind", !0, this))
                        },
                        ...
                        getFullyQualifiedURL: function () {
                            var a = this._getURL();
                            a += "?" + o.encode(this._getQS());
                            if (a.length > 2e3) {
                                a = "about:blank";
                                var b = ES(function () {
                                    this._postRequest(), this.unsubscribe("iframe.onload", b)
                                }, "bind", !0, this);
                        ...
                        _oneTimeSetup: function () {
                            this.subscribe("xd.resize", ES(this._handleResizeMsg, "bind", !0, this)), this.subscribe("xd.resize", ES(this._bubbleResizeEvent, "bind", !0, this)), this.subscribe("xd.resize.iframe", ES(this._resizeIframe, "bind", !0, this)), this.subscribe("xd.resize.flow", ES(this._resizeFlow, "bind", !0, this)), this.subscribe("xd.resize.flow", ES(this._bubbleResizeEvent, "bind", !0, this)), this.subscribe("xd.refreshLoginStatus", function () {
                                h.getLoginStatus(function () {
                                }, !0)
                            }), this.subscribe("xd.logout", function () {
                                q({method: "auth.logout", display: "hidden"}, function () {
                                })
                            }), this._refreshOnAuthChange && this._setupAuthRefresh(), this._visibleAfter == "load" && this.subscribe("iframe.onload", ES(this._makeVisible, "bind", !0, this)), this.subscribe("xd.verify", ES(function (a) {
                                this.arbiterInform("xd/verify", a.token)
                            }, "bind", !0, this)), this.oneTimeSetup()
                        },
                        _makeVisible: function () {
                            this._removeLoader(), j.removeCss(this.dom, "fb_hide_iframes"), this.fire("render")
                        },
                        _setupAuthRefresh: function () {
                            h.getLoginStatus(ES(function (a) {
                                var b = a.status;
                                k.subscribe("auth.statusChange", ES(function (a) {
                                    if (!this.isValid()) return;
                                    (b == "unknown" || a.status == "unknown") && this.process(!0);
                                    b = a.status
                                }, "bind", !0, this))
                            }, "bind", !0, this))
                        },
                        _handleResizeMsg: function (a) {
                            ...
                            this._resizeFlow(a);
                            this._borderReset || (this.getIframeNode().style.border = "none", this._borderReset = !0);
                            this._isResizeHandled = !0;
                            this._makeVisible()
                        },
                        _bubbleResizeEvent: function (a) {
                            a = {height: a.height, width: a.width, pluginID: this.getAttribute("plugin-id")};
                            k.fire("xfbml.resize", a)
                        },
                        _resizeIframe: function (a) {
                            var b = this.getIframeNode();
                            a.reposition === "true" && this._repositionIframe(a);
                        ...
                        _repositionIframe: function (a) {
                            var b = this.getIframeNode(), c = parseInt(j.getStyle(b, "width"), 10),
                                d = j.getPosition(b).x, e = j.getViewportInfo().width;
                            a = parseInt(a.width, 10);
                            d + a > e && d > a ? (b.style.left = c - a + "px", this.arbiterInform("xd/reposition", {type: "horizontal"}), this._repositioned = !0) : this._repositioned && (b.style.left = "0px", this.arbiterInform("xd/reposition", {type: "restore"}), this._repositioned = !1)
                        },
                        _addLoader: function () {
                            this._loaderDiv || (j.addCss(this.dom, "fb_iframe_widget_loader"), this._loaderDiv = document.createElement("div"), this._loaderDiv.className = "FB_Loader", this.dom.appendChild(this._loaderDiv))
                        },
                        _removeLoader: function () {
                            this._loaderDiv && (j.removeCss(this.dom, "fb_iframe_widget_loader"), this._loaderDiv.parentNode && this._loaderDiv.parentNode.removeChild(this._loaderDiv), this._loaderDiv = null)
                        },
                        _getQS: function () {
                            return ES("Object", "assign", !1, {
                ...
                __d("sdk.XFBML.Comments", ["sdk.Event", "sdk.XFBML.IframeWidget", "QueryString", "sdk.Runtime", "JSSDKConfig", "sdk.UA", "UrlMap"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    var n = 320;
                    a = h.extend({
                        _visibleAfter: "immediate", _refreshOnAuthChange: !0, setupAndValidate: function () {
                            __p && __p();
                            var a = {
                            ...
                            k.initSitevars.enableMobileComments && l.mobile() && a.mobile !== !1 && (a.mobile = !0);
                            ...
                            if (!a.href) {
                                ...
                                if (!a.xid) {
                                    ...
                                    b > 0 ? a.xid = encodeURIComponent(document.URL.substring(0, b)) : a.xid = encodeURIComponent(document.URL)
                                }
                                a.migrated && (a.href = m.resolve("www") + "/plugins/comments_v1.php?app_id=" + j.getClientID() + "&xid=" + encodeURIComponent(a.xid) + "&url=" + encodeURIComponent(a.url))
                            } else {
                                b = this.getAttribute("fb_comment_id");
                                b || (b = i.decode(document.URL.substring(ES(document.URL, "indexOf", !0, "?") + 1)).fb_comment_id, b && ES(b, "indexOf", !0, "#") > 0 && (b = b.substring(0, ES(b, "indexOf", !0, "#"))));
                                b && (a.fb_comment_id = b, this.subscribe("render", ES(function () {
                                    window.location.hash || (window.location.hash = this.getIframeNode().id)
                                }, "bind", !0, this)))
                            }
                            ...
                            this.subscribe("xd.sdk_event", function (a) {
                                g.fire(a.event, ES("JSON", "parse", !1, a.data))
                            })
                        }, getSize: function () {
                            if (!this._attr.permalink) return {
                                width: this._attr.mobile || this._attr.width === "auto" || this._attr.width === "100%" ? "100%" : Math.max(this._attr.width, n),
                                height: 100
                            }
                        }, getUrlBits: function () {
                            return {name: "comments", params: this._attr}
                        }, getDefaultWebDomain: function () {
                            return m.resolve("www", !0)
                        }
                    });
                    e.exports = a
                }), null);
                __d("sdk.XFBML.CommentsCount", ["ApiClient", "sdk.DOM", "sdk.XFBML.Element", "sprintf"], (function (a, b, c, d, e, f, g, h, i, j) {
                    a = i.extend({
                        process: function () {
                            ...
                            g.scheduleBatchCall("/v2.1/" + encodeURIComponent(a), {fields: "share"}, ES(function (a) {
                                a = a.share && a.share.comment_count || 0;
                                h.html(this.dom, j('<span class="fb_comments_count">%s</span>', a));
                                a > 0 && h.removeCss(this.dom, "fb_comments_count_zero");
                                this.fire("render")
                            }, "bind", !0, this))
                        }
                    });
                ...
                __d("getDocumentScrollElement", [], (function (a, b, c, d, e, f) {
                    "use strict";
                    var g = typeof navigator !== "undefined" && ES(navigator.userAgent, "indexOf", !0, "AppleWebKit") > -1;
                ...
                __d("sdk.DocumentTitle", [], (function (a, b, c, d, e, f) {
                    __p && __p();
                    var g = document.title, h = null, i = 1500, j = null, k = !1;
                ...
                __d("sdk.XFBML.CustomerChat", ["sdk.Content", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.DOM", "DOMEventListener", "sdk.Event", "IframePlugin", "QueryString", "sdk.UA", "sdk.XD", "sdk.createIframe", "getDocumentScrollElement"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    "use strict";
                    __p && __p();
                    var s = ["animationend", "mozAnimationEnd", "MSAnimationEnd", "oAnimationEnd", "webkitAnimationEnd"],
                        t = null, u = null, v = !1, w = null, x = "", y = 0, z = 0, A = null;
                    a = m.extend({
                        constructor: function (a, b, c, d) {
                            j.addCss(a, "fb_invisible_flow"), j.remove(a), g.append(a), this.parent(a, b, c, d), this._iframeOptions.title = "", l.fire("customerchat.load"), this._setUpSubscriptions(a)
                        }, _setUpSubscriptions: function (a) {
                            __p && __p();
                            this.subscribe("xd.liveChatPluginGetBubbleIframe", ES(function (a) {
                                this._handleGetBubbleIframe(a)
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginPrepareAnchorIframe", ES(function (a) {
                                ES("JSON", "parse", !1, a.isMobile) ? this._handlePrepareMobileAnchorIframe(a) : this._handlePrepareDesktopAnchorIframe(a)
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginResizeAnchorIframe", ES(function (a) {
                                this._handleResizeAnchorIframe(a)
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginExpandDialogIframe", ES(function (a) {
                                ES("JSON", "parse", !1, a.isMobile) ? this._handleExpandMobileDialogIframe(a) : this._handleExpandDesktopDialogIframe(a)
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginShowDialogIframe", ES(function (a) {
                                this._handleShowDialogIframe(a)
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginHideDialogIframe", ES(function (a) {
                                this._handleHideDialogIframe(a)
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginResetShadow", ES(function (a) {
                                this._handleResetShadow(a)
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginUpdatePageTitle", ES(function (a) {
                                this._handleUpdatePageTitle(a)
                            }, "bind", !0, this)), l.subscribe("customerchat.load", ES(function () {
                                this._handleCustomerChatLoad(a)
                            }, "bind", !0, this)), o.iphone() && (this.subscribe("xd.liveChatPluginFocusComposer", ES(function (a) {
                                this._handleFocusComposer()
                            }, "bind", !0, this)), this.subscribe("xd.liveChatPluginBlurComposer", ES(function (a) {
                            ...
                            this._bubbleDialog = this._setupNewIframeDialog(a.fromIframe, ES("JSON", "parse", !1, a.isHTTPS)), u = this._bubbleDialog, g.append(this._bubbleDialog), this.subscribe("xd.liveChatPluginShowBubbleIframe", ES(function (a) {
                                j.setStyle(this._bubbleDialog, "display", "inline"), ES("JSON", "parse", !1, a.showBadge) && this._setBubbleBadgeStyle()
                            }, "bind", !0, this))
                        }, _handlePrepareDesktopAnchorIframe: function (a) {
                            this._iframe && (this._iframe.setAttribute("data-testid", "dialog_iframe"), ES("Object", "assign", !1, this._iframe.style, {
                                borderRadius: "9pt",
                                bottom: "72pt",
                                boxShadow: "0 3pt 12pt rgba(0, 0, 0, 0.15)",
                                maxHeight: ES("JSON", "parse", !1, a.dialogHidden) ? "0" : "100%",
                                padding: "0",
                                position: "fixed",
                                right: "18pt",
                                top: "auto",
                                width: "270pt",
                                zIndex: "2147483647"
                            }), ES("JSON", "parse", !1, a.chatStarted) && (v = !0, ES("Object", "assign", !1, this._iframe.style, {height: "360pt"})), w = this._iframe)
                            ...
                            this._iframe && (this._iframe.setAttribute("data-testid", "dialog_iframe"), ES("Object", "assign", !1, this._iframe.style, {
                                ...
                                position: "fixed",
                                zIndex: "2147483647"
                            }), ES("JSON", "parse", !1, a.chatStarted) ? (v = !0, ES("Object", "assign", !1, this._iframe.style, {
                                boxShadow: "none",
                                height: "100%",
                                right: "0",
                                top: "0",
                                width: "100%"
                            }), ES("JSON", "parse", !1, a.dialogHidden) || B()) : ES("Object", "assign", !1, this._iframe.style, {
                                borderRadius: "9pt",
                                bottom: "72pt",
                                boxShadow: "0 3pt 12pt rgba(0, 0, 0, 0.15)",
                                right: "12pt",
                            ...
                            this._iframe && j.setStyle(this._iframe, "height", ES("JSON", "parse", !1, a.height) + "px")
                        }, _handleExpandDesktopDialogIframe: function () {
                            v = !0, this._iframe && j.setStyle(this._iframe, "height", "360pt")
                        }, _handleExpandMobileDialogIframe: function () {
                            v = !0, this._iframe && (j.setStyle(this._iframe, "boxShadow", "none"), j.setStyle(this._iframe, "border-radius", "0"), j.setStyle(this._iframe, "height", "100%"), j.setStyle(this._iframe, "right", "0"), j.setStyle(this._iframe, "top", "0"), j.setStyle(this._iframe, "width", "100%")), B()
                        }, _handleShowDialogIframe: function (a) {
                            D(this._iframe, ES("JSON", "parse", !1, a.chatStarted), ES("JSON", "parse", !1, a.isMobile))
                        }, _handleHideDialogIframe: function (a) {
                            E(this._iframe, ES("JSON", "parse", !1, a.chatStarted), ES("JSON", "parse", !1, a.isMobile))
                        }, _handleResetShadow: function (a) {
                            ES("JSON", "parse", !1, a.resetShadow) && this._bubbleDialog ? (j.setStyle(this._bubbleDialog, "boxShadow", "0px 3px 12px rgba(0, 0, 0, 0.15)"), j.setStyle(this._bubbleDialog, "borderRadius", "50%")) : ES("JSON", "parse", !1, a.dialogHidden) && this._setBubbleBadgeStyle()
                        }, _handleUpdatePageTitle: function (a) {
                            !t && a.titleText ? (t = i.blink(a.titleText), k.add(window, "focus", ES(function (a) {
                                this._stopBlinking()
                            }, "bind", !0, this))) : t && !a.titleText && this._stopBlinking()
                        }, _handleFocusComposer: function () {
                            setTimeout(ES(function () {
                                var a = r();
                                a && (j.setStyle(this._iframe, "maxHeight", a.scrollHeight - a.scrollTop + "px"), a.scrollTo(0, 0))
                            }, "bind", !0, this), 700)
                        }, _handleBlurComposer: function () {
                            j.setStyle(this._iframe, "maxHeight", "100%")
                        }, _handleCustomerChatLoad: function (a) {
                            j.remove(a), j.remove(this._bubbleDialog)
                        }, _setupNewIframeDialog: function (a, b) {
                            a = "#" + n.encode({forIframe: a});
                            var c = h.setupNewDialog();
                            j.setStyle(c.contentRoot, "background", "none");
                            x = this._iframeOptions.name;
                            q({
                                url: p.getXDArbiterURL(b) + a,
                            ...
                            ES("Object", "assign", !1, c.dialogElement.style, {
                                background: "none",
                                borderRadius: "50%",
                                bottom: "18pt",
                            ...
                            this._bubbleDialog && (j.setStyle(this._bubbleDialog, "boxShadow", "-5px 4px 14px rgba(0, 0, 0, 0.15)"), j.setStyle(this._bubbleDialog, "borderRadius", "50% 0% 50% 50%"))
                    ...
                    function B() {
                        y = window.pageXOffset !== undefined ? window.pageXOffset : document.documentElement && document.documentElement.scrollLeft, z = window.pageYOffset !== undefined ? window.pageYOffset : document.documentElement && document.documentElement.scrollTop, j.addCss(document.body, "fb_mobile_overlay_active")
                    }

                    function C() {
                        j.removeCss(document.body, "fb_mobile_overlay_active"), window.scrollTo(y, z)
                    }

                    function D(a, b, c) {
                        var d = arguments.length <= 3 || arguments[3] === undefined ? !0 : arguments[3];
                        if (!a) return;
                        (A === null || A === !1) && (c && b && B(), j.removeCss(a, "fb_customer_chat_bounce_out"), j.addCss(a, "fb_customer_chat_bounce_in"), j.setStyle(a, "maxHeight", "100%"), A = !0);
                        d && l.fire("customerchat.dialogShow")
                    }

                    function E(a, b, c) {
                        __p && __p();
                        var d = arguments.length <= 3 || arguments[3] === undefined ? !0 : arguments[3], e = a;
                        if (!e) return;
                        (A === null || A === !0) && (function () {
                            var a = function a(b) {
                                b.animationName === "fb_fade_out" && (j.setStyle(e, "maxHeight", "0"), ES(s, "forEach", !0, function (event) {
                                    k.remove(e, event, a)
                                }))
                            };
                            c && b && C();
                            j.removeCss(e, "fb_customer_chat_bounce_in");
                            j.addCss(e, "fb_customer_chat_bounce_out");
                            ES(s, "forEach", !0, function (event) {
                                k.add(e, event, a)
                            });
                            A = !1
                        })();
                        d && l.fire("customerchat.dialogHide")
                    }

                    a.show = function () {
                        var a = arguments.length <= 0 || arguments[0] === undefined ? !0 : arguments[0];
                        j.setStyle(u, "display", "inline");
                        a && D(w, v, o.mobile(), !1);
                        l.fire("customerchat.show")
                    };
                    a.hide = function () {
                        j.setStyle(u, "display", "none"), E(w, v, o.mobile(), !1), l.fire("customerchat.hide")
                    };
                    a.showDialog = function () {
                        j.setStyle(u, "display", "inline"), D(w, v, o.mobile())
                    };
                ...
                __d("sdk.Helper", ["sdk.ErrorHandling", "sdk.Event", "UrlMap", "safeEval", "sprintf"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    ...
                    a = {
                        isUser: function (a) {
                            return a < 22e8 || a >= 1e14 && a <= 100099999989999 || a >= 89e12 && a <= 89999999999999 || a >= 6000001e7 && a <= 60000019999999
                        }, upperCaseFirstChar: function (a) {
                            if (a.length > 0) return a.substr(0, 1).toUpperCase() + a.substr(1); else return a
                        }, getProfileLink: function (a, b, c) {
                            !c && a && (c = k("%s/profile.php?id=%s", i.resolve("www"), a.uid || a.id));
                            c && (b = k('<a class="fb_link" href="%s">%s</a>', c, b));
                            return b
                        }, invokeHandler: function (a, b, c) {
                            a && (typeof a === "string" ? g.unguard(j)(a, c) : a.apply && g.unguard(a).apply(b, c || []))
                        }, fireEvent: function (a, b) {
                            var c = b._attr.href;
                            b.fire(a, c);
                            h.fire(a, c, b)
                        }, executeFunctionByName: function (a) {
                            var b = Array.prototype.slice.call(arguments, 1), c = a.split("."), d = c.pop(), e = window;
                ...
                __d("sdk.XFBML.LoginButton", ["sdk.Helper", "IframePlugin", "Log", "sdk.ui", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    a = h.extend({
                        constructor: function (a, b, c, d) {
                            __p && __p();
                            this.parent(a, b, c, d);
                            var e = h.getVal(d, "on_login"), f = null, l = this._iframeOptions.name;
                            e && (f = function (a) {
                                if (a.error_code) {
                                    i.debug("Plugin Return Error (%s): %s", a.error_code, a.error_message || a.error_description);
                                    return
                                }
                                g.invokeHandler(e, null, [a])
                            }, this.subscribe("login.status", f));
                            this.subscribe("xd.login_button_dialog_open", function (a) {
                                j(ES("JSON", "parse", !1, a.params), function (a) {
                                    g.invokeHandler(f, null, [a]), k.sendToFacebook(l, {
                                        method: "loginReload",
                                        params: ES("JSON", "stringify", !1, a)
                                    })
                                })
                ...
                __d("sdk.XFBML.Name", ["ApiClient", "escapeHTML", "sdk.Event", "sdk.XFBML.Element", "sdk.Helper", "Log", "sdk.Runtime"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    a = j.extend({
                        process: function () {
                            ...
                            var a = [];
                            this._firstnameonly ? a.push("first_name") : this._lastnameonly ? a.push("last_name") : a.push("name");
                            this._subjectId && (a.push("gender"), this._subjectId == m.getUserID() && (this._reflexive = !0));
                            i.monitor("auth.statusChange", ES(function () {
                                ...
                                (!this._uid || this._uid == "loggedinuser") && (this._uid = m.getUserID());
                                if (!this._uid) return;
                                g.scheduleBatchCall("/v1.0/" + this._uid, {fields: a.join(",")}, ES(function (a) {
                                    if (n.call(a, "error")) {
                                        l.warn("The name is not found for ID: " + this._uid);
                                        return
                                    }
                                    this._subjectId == this._uid ? this._renderPronoun(a) : this._renderOther(a);
                                    this.fire("render")
                                }, "bind", !0, this))
                            }, "bind", !0, this))
                            ...
                            this._subjectId && (c = !0, this._subjectId === this._uid && (this._reflexive = !0));
                            if (this._uid == m.getUserID() && this._getBoolAttribute("use-you", !0)) this._possessive ? this._reflexive ? b = "your own" : b = "your" : this._reflexive ? b = "yourself" : b = "you"; else switch (a.gender) {
                                case"male":
                                    this._possessive ? b = this._reflexive ? "his own" : "his" : this._reflexive ? b = "himself" : c ? b = "him" : b = "he";
                                    break;
                                case"female":
                                    this._possessive ? b = this._reflexive ? "her own" : "her" : this._reflexive ? b = "herself" : c ? b = "her" : b = "she";
                                    break;
                                default:
                                    this._getBoolAttribute("use-they", !0) ? this._possessive ? this._reflexive ? b = "their own" : b = "their" : this._reflexive ? b = "themselves" : c ? b = "them" : b = "they" : this._possessive ? this._reflexive ? b = "his/her own" : b = "his/her" : this._reflexive ? b = "himself/herself" : c ? b = "him/her" : b = "he/she";
                                    break
                            }
                            this._getBoolAttribute("capitalize", !1) && (b = k.upperCaseFirstChar(b));
                            this.dom.innerHTML = b
                        }, _renderOther: function (a) {
                            var b = "", c = "";
                            this._uid == m.getUserID() && this._getBoolAttribute("use-you", !0) ? this._reflexive ? this._possessive ? b = "your own" : b = "yourself" : this._possessive ? b = "your" : b = "you" : a && (null === a.first_name && (a.first_name = ""), null === a.last_name && (a.last_name = ""), this._firstnameonly && a.first_name !== undefined ? b = h(a.first_name) : this._lastnameonly && a.last_name !== undefined && (b = h(a.last_name)), b || (b = h(a.name)), b !== "" && this._possessive && (b += "'s"));
                            b || (b = h(this.getAttribute("if-cant-see", "Facebook User")));
                            b && (this._getBoolAttribute("capitalize", !1) && (b = k.upperCaseFirstChar(b)), a && this._linked ? c = k.getProfileLink(a, b, this.getAttribute("href", null)) : c = b);
                ...
                __d("UnicodeUtils", ["invariant"], (function (a, b, c, d, e, f, g) {
                    "use strict";
                    __p && __p();
                    var h = 55296, i = 56319, j = 56320, k = 57343, l = /[\uD800-\uDFFF]/;
                ...
                __d("containsNode", ["isTextNode"], (function (a, b, c, d, e, f, g) {
                    ...
                    function h(a, b) {
                        __p && __p();
                        if (!a || !b) return !1; else if (a === b) return !0; else if (g(a)) return !1; else if (g(b)) return h(a, b.parentNode); else if ("contains" in a) return ES(a, "contains", !0, b); else if (a.compareDocumentPosition) return !!(a.compareDocumentPosition(b) & 16); else return !1
                    }

                    e.exports = h
                }), 18);
                __d("sdk.XFBML.Quote", ["sdk.DOM", "DOMEventListener", "IframePlugin", "UnicodeUtils", "sdk.UA", "sdk.XD", "containsNode", "sdk.feature"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    "use strict";
                    __p && __p();
                    var o = "fb-quotable", p = 155, q = 70, r = "", s = null, t = [], u = !1, v = null, w = k.mobile();
                    ...
                    function y(a) {
                        ...
                        if (b) {
                            var c = !1;
                            for (var d = 0; d < b; d++) if (m(t[d], a.focusNode)) {
                                c = !0;
                                break
                            }
                            if (!c) return
                        ...
                        b = Number(n("sharequotelimit", 500));
                        j.strlen(r) > b ? r = j.substr(r, 0, b - 3) + "..." : r = j.substr(r, 0, b);
                        if (!u && v) {
                            x(a).appendChild(v);
                            d = z(a);
                            v.style.left = d.x + "px";
                    ...
                    function z(a) {
                        __p && __p();
                        var b = v && v.offsetWidth, c = b ? v.offsetHeight : q;
                        b = b ? v.offsetWidth : p;
                        a = a.getRangeAt(0);
                    ...
                    a = i.extend({
                        constructor: function (a, b, c, d) {
                            ...
                            if (s) return s;
                            this.parent(a, b, c, d);
                            u = g.getAttr(a, "layout") === "button";
                            v = a;
                            v.style.position = "absolute";
                            v.style.display = "";
                            h.add(document, "keyup", y);
                            h.add(document, "mouseup", y);
                            this.subscribe("xd.getTextSelection", ES(function () {
                                l.sendToFacebook(this._iframeOptions.name, {
                                    method: "setTextSelection",
                                    params: ES("JSON", "stringify", !1, {text: r})
                                }), A()
                            }, "bind", !0, this));
                            t = ES(ES("Array", "from", !1, document.getElementsByTagName("*")), "filter", !0, function (a) {
                                return a.nodeName.toLowerCase() === "article" || g.containsCss(a, o)
                            });
                            A();
                            s = this;
                            return s
                ...
                __d("sdk.XFBML.Save", ["sdk.Content", "sdk.DialogUtils", "sdk.DOM", "sdk.Event", "IframePlugin", "QueryString", "sdk.UA", "sdk.XD", "sdk.createIframe"], (function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    "use strict";
                    __p && __p();
                    var p = void 0;
                    a = k.extend({
                        constructor: function (a, b, c, d) {
                            ...
                            this.parent(a, b, c, d);
                            var e = m.mobile();
                            this.subscribe("xd.savePluginGetBlankIframe", ES(function (a) {
                                __p && __p();
                                var b = void 0, c = void 0, d = void 0, f = function (a) {
                                    a && i.removeCss(a, "fb_invisible")
                                }, k = function (a) {
                                    a && i.addCss(a, "fb_invisible")
                                };
                                e && (b = h.setupNewDarkOverlay(), k(b), g.append(b), h.addDoubleClickAction(b, function () {
                                    return ES(d, "forEach", !0, k)
                                }, 5e3));
                                c = this.setupNewIframeDialog(ES("JSON", "parse", !1, a.data), a.fromIframe, ES("JSON", "parse", !1, a.isHTTPS));
                                k(c);
                                g.append(c);
                                d = [c, b];
                                var l = function () {
                                    ES(d, "forEach", !0, k), h.onDialogHideCleanup(e), clearInterval(p)
                                }, m = void 0;
                                this.subscribe("xd.savePluginShowIframe", ES(function () {
                                    j.fire("savePlugin:hideDialog"), ES(d, "forEach", !0, f), this.positionOnScreen(c, b), !e && !m && (m = h.addIdleDesktopAction(c, l, 7e3))
                                }, "bind", !0, this));
                                this.subscribe("xd.savePluginHideIframe", function () {
                                    return l()
                                });
                                j.subscribe("savePlugin:hideDialog", function () {
                                    return l()
                                });
                                var n = setInterval(function () {
                                    var b = document.getElementsByName(a.fromIframe);
                                    b.length === 0 && (clearInterval(n), l(), ES(d, "forEach", !0, function (a) {
                            ...
                            c ? (function () {
                                var d = function (a, b) {
                                    b != null && h.setDialogPositionToCenter(b, c), h.setDialogPositionToCenter(a, c)
                                };
                                d(a, b);
                                h.addMobileOrientationChangeAction(function (c) {
                                    d(a, b)
                                });
                                p = setInterval(function () {
                                    return d(a, b)
                                }, 100)
                            })() : (i.setStyle(a, "position", "fixed"), i.setStyle(a, "top", "20px"), i.setStyle(a, "right", "20px"))
                        }, setupNewIframeDialog: function (a, b, c) {
                            __p && __p();
                            b = "#" + l.encode({forIframe: b});
                            var d = h.setupNewDialog();
                            o({
                                url: n.getXDArbiterURL(c) + b,
                                name: "blank_" + this._iframeOptions.name,
                                root: d.contentRoot,
                                tabindex: -1
                            });
                            i.addCss(d.contentRoot, "fb_dialog_iframe");
                            ES("Object", "assign", !1, d.dialogElement.style, a.style || {});
                            i.setStyle(d.dialogElement, "width", a.width + "px");
                            i.setStyle(d.dialogElement, "height", a.height + "px");
                            ES(a.classList, "forEach", !0, function (a) {
                                return i.addCss(d.dialogElement, a)
                            });
                            i.removeCss(d.dialogElement, "fb_dialog_advanced");
                            return d.dialogElement
                        }, getParams: function () {
                ...
                __d("sdk.XFBML.ShareButton", ["IframePlugin", "sdk.UA", "sdk.ui"], (function (a, b, c, d, e, f, g, h, i) {
                    "use strict";
                    a = g.extend({
                        constructor: function (a, b, c, d) {
                            this.parent(a, b, c, d), this.subscribe("xd.shareTriggerMobileIframe", function (a) {
                                a = ES("JSON", "parse", !1, a.data);
                                i({method: "share", href: a.href, mobile_iframe: h.mobile()})
                            })
                        }, getParams: function () {
                            return {
                                href: "url",
                ...
                __d("sdk.XFBML.Video", ["Assert", "sdk.Event", "IframePlugin", "ObservableMixin", "sdk.XD"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    __p && __p();
                    ...
                    l.prototype.update = function (a) {
                        "use strict";
                        a.isMuted !== undefined && (this.$1 = a.isMuted), a.volume !== undefined && (this.$2 = a.volume), a.timePosition !== undefined && (this.$3 = a.timePosition), a.duration !== undefined && (this.$4 = a.duration)
                    };
                    ...
                    m.prototype.play = function () {
                        "use strict";
                        k.sendToFacebook(this.$1, {method: "play", params: ES("JSON", "stringify", !1, {})})
                    };
                    m.prototype.pause = function () {
                        "use strict";
                        k.sendToFacebook(this.$1, {method: "pause", params: ES("JSON", "stringify", !1, {})})
                    };
                    m.prototype.seek = function (a) {
                        "use strict";
                        g.isNumber(a, "Invalid argument"), k.sendToFacebook(this.$1, {
                            method: "seek",
                    ...
                    m.prototype.mute = function () {
                        "use strict";
                        k.sendToFacebook(this.$1, {method: "mute", params: ES("JSON", "stringify", !1, {})})
                    };
                    m.prototype.unmute = function () {
                        "use strict";
                        k.sendToFacebook(this.$1, {method: "unmute", params: ES("JSON", "stringify", !1, {})})
                    };
                    ...
                    a = i.extend({
                        constructor: function (a, b, c, d) {
                            this.parent(a, b, c, d), this._videoController = null, this._sharedObservable = null, this._sharedVideoCache = null, this.subscribe("xd.onVideoAPIReady", function (a) {
                                this._sharedObservable = new j(), this._sharedVideoCache = new l(ES("JSON", "parse", !1, a.data)), this._videoController = new m(this._iframeOptions.name, this._sharedObservable, this._sharedVideoCache), h.fire("xfbml.ready", {
                                    type: "video",
                                    id: d.id,
                ...
                __d("legacy:fb.xfbml.plugins", ["IframePlugin", "PluginConfig", "PluginTags", "XFBML", "sdk.feature", "sdk.XFBML.CustomerChat", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.LoginButton", "sdk.XFBML.Name", "sdk.XFBML.Quote", "sdk.XFBML.Save", "sdk.XFBML.ShareButton", "sdk.XFBML.Video"], (function (a, b, c, d, e, f, g, h, i, j, k) {
                    var l = {
                    ...
                    ES(ES("Object", "keys", !1, i), "forEach", !0, function (a) {
                        ...
                        j.registerTag({xmlns: "fb", localName: a.replace(/_/g, "-"), ctor: g.withParams(i[a], h[a])})
                    });
                    ES(ES("Object", "keys", !1, l), "forEach", !0, function (a) {
                        if (ES(m, "indexOf", !0, a) !== -1) return;
                        j.registerTag({xmlns: "fb", localName: a.replace(/_/g, "-"), ctor: l[a]})
                    })
                }), 3);
            }
        }).call(global);
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"3963173","namespace":"FB","message":"' + e.message + '"}}');
}