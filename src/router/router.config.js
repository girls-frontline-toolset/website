...
let metaData = {
  ...
  time:{
    girl:{
      title:{"cn":cn.title.h1.time.girl,"tw":tw.title.h1.time.girl,"ja":ja.title.h1.time.girl,"en":en.title.h1.time.girl},
    ...
    fairy:{
      title: {"cn":cn.title.h1.time.fairy,"tw":tw.title.h1.time.fairy,"ja":ja.title.h1.time.fairy,"en":en.title.h1.time.fairy},
      description:"裝備製造時間查詢 屬性上有細微的差異 45 55 52 51 50 49 48 42 5 38",
      image:{url:"/common/device/ty_012.png",width:"240",height:"240"},
    },
    device:{
      title: {"cn":cn.title.h1.time.device,"tw":tw.title.h1.time.device,"ja":ja.title.h1.time.device,"en":en.title.h1.time.device},
  ...
  list:{
    girl:{
      title: {"cn":cn.title.h1.list.girl,"tw":tw.title.h1.list.girl,"ja":ja.title.h1.list.girl,"en":en.title.h1.list.girl},
    ...
    fairy:{
      title: {"cn":cn.title.h1.list.fairy,"tw":tw.title.h1.list.fairy,"ja":ja.title.h1.list.fairy,"en":en.title.h1.list.fairy},
    ...
    wafer:{
      title: {"cn":cn.title.h1.list.wafer,"tw":tw.title.h1.list.wafer,"ja":ja.title.h1.list.wafer,"en":en.title.h1.list.wafer},
      description:"一個齊全的 少前前線 晶片圖鑑",
      image:{url:"/common/cell/6/010000-111000-110000-000000-000000-000000-0.png",width:"241",height:"156"},
    },
    support_unit:{
      title: {"cn":cn.title.h1.list["support-unit"],"tw":tw.title.h1.list["support-unit"],"ja":ja.title.h1.list["support-unit"],"en":en.title.h1.list["support-unit"]},
      description:"一個齊全的 少前前線 重裝圖鑑 AGS-30 2B14 BFM-71",
      image:{url:"/common/supportUnit/3/5.png",width:"420",height:"420"},
    },
    doc:{
      title: {"cn":cn.title.h1.list.doc,"tw":tw.title.h1.list.doc,"ja":ja.title.h1.list.doc,"en":en.title.h1.list.doc},
      search:{
        title: {"cn":cn.doc.search,"tw":tw.doc.search,"ja":ja.doc.search,"en":en.doc.search},
      },
      add:{
        title: {"cn":cn.doc.add,"tw":tw.doc.add,"ja":ja.doc.add,"en":en.doc.add},
      }
    }
  },
  tool:{
    ...
    chrome:{
      title: {"cn":cn.nav["other-platform"].chrome,"tw":tw.nav["other-platform"].chrome,"ja":ja.nav["other-platform"].chrome,"en":en.nav["other-platform"].chrome},
  ...
  bot:{
    line:{
      title: {"cn":cn.line.command,"tw":tw.line.command,"ja":ja.line.command,"en":en.line.command},
      description:"這是同好寫的line 機械人喔!可以加入群組 版本:V1.1 **禁止用作商業用途**",
      image:{url:"/common/img/line-bot.jpg",width:"500",height:"500"},
      img:{
        title: {"cn":cn.line.img,"tw":tw.line.img,"ja":ja.line.img,"en":en.line.img},
        description:"這是同好寫的line 機械人喔!可以加入群組 版本:V1.1 **禁止用作商業用途**",
        image:{url:"/common/img/line-bot.jpg",width:"500",height:"500"},
      }
    }
  ...
  more:{
    line:{
      title: {"cn":cn.nav["line-group"],"tw":tw.nav["line-group"],"ja":ja.nav["line-group"],"en":en.nav["line-group"]},
      description:"少前同好群，歡迎加入LINE群 歡迎各位新手,大佬和萌新",
      image:{url:"/common/img/group.jpg",width:"500",height:"500"},
    },
    about:{
      title: {"cn":cn.footer.about,"tw":tw.footer.about,"ja":ja.footer.about,"en":en.footer.about},
    ...
    link:{
      title: {"cn":cn.footer.link,"tw":tw.footer.link,"ja":ja.footer.link,"en":en.footer.link},
    },
    feedback:{
      title: {"cn":cn.footer.feedback,"tw":tw.footer.feedback,"ja":ja.footer.feedback,"en":en.footer.feedback},
    },
    privacy_policy:{
      title: {"cn":cn.footer["privacy-policy"],"tw":tw.footer["privacy-policy"],"ja":ja.footer["privacy-policy"],"en":en.footer["privacy-policy"]},
    },
    sitemap:{
      title: {"cn":cn.title.h1.more.sitemap,"tw":tw.title.h1.more.sitemap,"ja":ja.title.h1.more.sitemap,"en":en.title.h1.more.sitemap},
    }
  },
  fb:{
    list:{
      title: {"cn":cn.title.h1.fb.list,"tw":tw.title.h1.fb.list,"ja":ja.title.h1.fb.list,"en":en.title.h1.fb.list},
      description:"好友招募區域 招募少女前線的好友",
    }
  },
  log:{
    update:{
      title: {"cn":cn.footer["update-log"],"tw":tw.footer["update-log"],"ja":ja.footer["update-log"],"en":en.footer["update-log"]},
    }
  },
  like:{
    list:{
      title: {"cn":cn.nav["friends-list"]["like-list"],"tw":tw.nav["friends-list"]["like-list"],"ja":ja.nav["friends-list"]["like-list"],"en":en.nav["friends-list"]["like-list"]},
  ...
  make:{
    ...
    wafer:{
      title: {"cn":cn.title.h1.make.wafer,"tw":tw.title.h1.make.wafer,"ja":ja.title.h1.make.wafer,"en":en.title.h1.make.wafer},
  ...
  image:{
    add:{
      title: {"cn":cn.footer["add-image"],"tw":tw.footer["add-image"],"ja":ja.footer["add-image"],"en":en.footer["add-image"]},
    },
    name:{
      title: {"cn":cn.title.h1.img,"tw":tw.title.h1.img,"ja":ja.title.h1.img,"en":en.title.h1.img},
      description:"少前前線圖片庫 WA2000 IDW MP5 春田 雷電 TMP",
    }
  },
  admin:{
    image:{
      title: {"cn":"圖片管理","tw":'圖片管理',"ja":"圖片管理","en":"圖片管理"}
    },
    errorImg:{
      title: {"cn":"問題圖片","tw":'問題圖片',"ja":"問題圖片","en":"問題圖片"}
    },
    setting:{
      title: {"cn":"設定","tw":'設定',"ja":"設定","en":"設定"}
    },
    doc:{
      title: {"cn":"實用文庫管理","tw":'實用文庫管理',"ja":"實用文庫管理","en":"實用文庫管理"}
    },
    schedule:{
      title: {"cn":"增加時間表活動","tw":'增加時間表活動',"ja":"增加時間表活動","en":"增加時間表活動"}
    },
    girl:{
      title: {"cn":"人型編輯","tw":'人型編輯',"ja":"人型編輯","en":"人型編輯"}
    },
    login:{
      title: {"cn":"登入","tw":'登入',"ja":"登入","en":"登入"}
    },
    logout:{
      title: {"cn":"登出","tw":'登出',"ja":"登出","en":"登出"}
    },
    referrer:{
      title: {"cn":"url","tw":'url',"ja":"url","en":"url"}
    },
  },
  event:{
    schedule:{
      title: {"cn":"活动时间表(繁中版)","tw":'活動時間表(繁中版)',"ja":"活動スケジュール(台湾版)","en":"Event Schedule (tw Ver)"}
    }
  },
  magical_tool:{
    so_appetizing:{
  ...
  breadcrumbList:{
    title: {"cn":cn.title.h1.breadcrumbList,"tw":tw.title.h1.breadcrumbList,"ja":ja.title.h1.breadcrumbList,"en":en.title.h1.breadcrumbList},
  },
  contributor:{
    register: {
      title:{"cn":cn.contributor.img,"tw":tw.contributor.img,"ja":ja.contributor.img,"en":en.contributor.img}
      },
  }
};
