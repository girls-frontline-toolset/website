                ...
                <v-navigation-drawer temporary fixed v-model="drawer" class="white">
                    <v-list>
                        ...
                        <v-layout justify-space-around>
                            <a class="unLine" href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent(location.href)) ));"><v-icon size="24px">icon-facebook</v-icon></a>
                            <a class="unLine" href="javascript: void(window.open('http://twitter.com/home/?status='.concat(encodeURIComponent(document.title)) .concat(' ') .concat(encodeURIComponent(location.href))));"><v-icon size="24px">icon-twitter</v-icon></a>
                            <a class="unLine" href="http://line.naver.jp/R/msg/text/?少女前線 工具集 https://www.ntw-20.com"><v-icon size="24px">icon-line</v-icon></a>
                        </v-layout>
                    </v-list>
                </v-navigation-drawer>
            </v-layout>
