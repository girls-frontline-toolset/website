<template>
    <v-container grid-list-md pa-0 mt-1>
        <v-layout row wrap>
          ...
          <gl-ui-avatar-card icon-img="/common/img/girls-frontline-toolset.jpg" title="GitHub" name="girls-frontline-toolset">
          ...
          <v-flex xs12>
            <gl-ui-title :text="$t('about.contributor')" h2></gl-ui-title>
          </v-flex>
      </v-layout>
  </v-container>
</template>
