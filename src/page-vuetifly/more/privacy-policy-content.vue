    ...
    <v-container grid-list-md pt-0>
        <v-layout row wrap>
            ...
            <v-flex xs12 class="privacy_policy">
                ...
                <p>少女前線-工具集 ("us", "we", or "our") operates the https://www.ntw-20.com website and the 少女前線-工具集 mobile
                    application (hereinafter referred to as the "Service").</p>

                <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data
                    when you use our Service and the choices you have associated with that data. This Privacy Policy for
                    少女前線-工具集 is powered by <a href="https://privacypolicies.com/free-privacy-policy-generator/">PrivacyPolicies.com</a>.
                </p>
                ...
                <p>少女前線-工具集 uses the collected data for various purposes:</p>
                <ul>
                ...
                <p>If you are located outside Hong Kong and choose to provide information to us, please note that we
                    transfer the data, including Personal Data, to Hong Kong and process it there.</p>
                ...
                <p>少女前線-工具集 will take all steps reasonably necessary to ensure that your data is treated securely and in
                ...
                <p>少女前線-工具集 may disclose your Personal Data in the good faith belief that such action is necessary
                    to:</p>
                <ul>
                    <li>To comply with a legal obligation</li>
                    <li>To protect and defend the rights or property of 少女前線-工具集</li>
                ...
                <ul>
                    <li>By email: admin@ntw-20.com</li>
                    <li>By visiting this page on our website: https://www.ntw-20.com/more/feedback</li>
